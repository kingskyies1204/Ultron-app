...
If you don't, ask. Never invent phone numbers.`,$s=`https://api.elevenlabs.io/v1`,ec=`eleven_v3`,tc=`eleven_multilingual_v2`,nc=`eleven_flash_v2_5`,rc=class extends Error{};async function ic(e){if(e.ok)return e;let t=``;try{let n=await e.json();t=n?.detail?.message||n?.detail?.status||(typeof n?.detail==`string`?n.detail:``)}catch{}throw e.status===401?new rc(`ElevenLabs rejected the API key${t?`: ${t}`:`.`}`):e.status===429?new rc(`ElevenLabs is rate limiting you. Slow down a sec.`):new rc(`ElevenLabs error ${e.status}${t?`: ${t}`:``}`)}async function ac(e){let t=await(await ic(await fetch(`${$s}/voices`,{headers:{"xi-api-key":e}}))).json();return Array.isArray(t?.voices)?t.voices:[]}var oc={voice_id:`CwhRBWXzGAHq8TQ4Fs17`,name:`Roger`},sc=e=>e instanceof rc&&/voices_read/i.test(e.message),cc=[`Roger`,`Chris`,`Will`,`Eric`,`Liam`,`Brian`];function lc(e){for(let t of cc){let n=e.find(e=>e.name.toLowerCase().startsWith(t.toLowerCase()));if(n)return n.voice_id}return e[0]?.voice_id??``}var uc=!1;async function dc(e,t,n,r){return fetch(`${$s}/text-to-speech/${encodeURIComponent(t)}?output_format=mp3_44100_128`,{method:`POST`,signal:r,headers:{"xi-api-key":e,"Content-Type":`application/json`,Accept:`audio/mpeg`},body:JSON.stringify(n)})}async function fc(e,t,n,r,i=``,a=1,o=!1){let s=Math.min(1.2,Math.max(.7,a));if(!uc&&!o){let i=await dc(e,t,{text:n,model_id:ec,voice_settings:{stability:.5,similarity_boost:.8,use_speaker_boost:!0}},r);if(i.ok)return{bytes:await i.arrayBuffer(),applied:1};i.status===400||i.status===403||i.status===422?uc=!0:await ic(i)}return{bytes:await(await ic(await dc(e,t,{text:n,model_id:o?nc:tc,voice_settings:{stability:.38,similarity_boost:.8,style:.3,use_speaker_boost:!0,speed:s},...i?{previous_text:i.slice(-500)}:{}},r))).arrayBuffer(),applied:s}}var pc={"openai/gpt-oss-120b":{label:`GPT-OSS 120B (OpenAI) · FREE via Groq`,provider:`groq`,inPerM:0,outPerM:0},"openai/gpt-oss-20b":{label:`GPT-OSS 20B (OpenAI) · FREE, fastest`,provider:`groq`,inPerM:0,outPerM:0},"llama-3.3-70b-versatile":{label:`Llama 3.3 70B · FREE via Groq`,provider:`groq`,inPerM:0,outPerM:0},"gemini-3.8-flash":{label:`Gemini 3.8 Flash · FREE`,provider:`gemini`,inPerM:0,outPerM:0},"gemini-2.5-flash":{label:`Gemini 2.5 Flash · FREE`,provider:`gemini`,inPerM:0,outPerM:0},"gemini-2.5-pro":{label:`Gemini 2.5 Pro · FREE, slower`,provider:`gemini`,inPerM:0,outPerM:0},"claude-opus-5":{label:`Claude Opus 5 · $5/$25`,provider:`claude`,inPerM:5,outPerM:25},"claude-sonnet-5":{label:`Claude Sonnet 5 · $2/$10`,provider:`claude`,inPerM:2,outPerM:10},"claude-haiku-4-5":{label:`Claude Haiku 4.5 · $1/$5`,provider:`claude`,inPerM:1,outPerM:5}},mc=e=>pc[e].provider,hc=`gemini-3.8-flash`,gc={groq:`openai/gpt-oss-120b`,gemini:hc,claude:`claude-sonnet-5`};function _c(e){let t=e.trim();return t.startsWith(`gsk_`)?`groq`:t.startsWith(`AIza`)?`gemini`:t.startsWith(`sk-ant-`)?`claude`:null}var vc=`ultron.settings.v1`,yc=`ultron.memory.v1`;function bc(e){let t=(e||``).split(/[@.]/)[0].replace(`_`,`-`).trim();return/^[a-z]{2,3}(-[A-Za-z0-9]{2,8})*$/i.test(t)?t:`en-US`}var xc={apiKey:``,geminiKey:``,groqKey:``,model:`openai/gpt-oss-120b`,voiceURI:``,speechLang:bc(typeof navigator<`u`?navigator.language:``),damage:0,webSearch:!0,elevenKey:``,elevenVoiceId:``,elevenCustomVoiceId:``,voiceStyle:`natural`,voiceRev:3,voiceFast:!1,voiceSpeed:1.18,voiceDepth:0};function Sc(e,t){try{let n=localStorage.getItem(e);return n?{...t,...JSON.parse(n)}:t}catch{return t}}function Cc(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}}function wc(){let e=Sc(vc,{}),t={...xc,...e};return t.model in pc||(t.model=xc.model),e.voiceStyle===void 0&&e.damage===.15&&(t.damage=0),(e.voiceRev??0)<2&&(t.voiceStyle!==`robot`&&(t.voiceStyle=`natural`),t.voiceDepth=0,t.voiceRev=2),t.voiceRev<3&&(t.voiceSpeed=Math.max(t.voiceSpeed,1.18),t.elevenVoiceId===`pNInz6obpgDQGcFmaJgB`&&(t.elevenVoiceId=oc.voice_id),t.voiceRev=3),Ec(t)}var Tc=(e,t)=>t===`groq`?e.groqKey:t===`gemini`?e.geminiKey:e.apiKey;function Ec(e){if(Tc(e,mc(e.model)))return e;for(let t of[`groq`,`gemini`,`claude`])if(Tc(e,t))return{...e,model:gc[t]};return{...e,model:xc.model}}function Dc(e){Cc(vc,e)}function Oc(){try{let e=localStorage.getItem(yc),t=e?JSON.parse(e):[];return Array.isArray(t)?t.filter(e=>typeof e==`string`):[]}catch{return[]}}function kc(e){Cc(yc,e.slice(-100))}var Ac=(e,t)=>({type:`object`,properties:e,required:t,additionalProperties:!1}),jc=[{name:`phone_action`,description:`Prepare a phone action as a tap-to-run button: call, facetime, text (SMS/iMessage), whatsapp, email, maps (search or directions), open_url (https website) or open_app (by app name).`,eager_input_streaming:!0,input_schema:Ac({kind:{type:`string`,enum:[`call`,`facetime`,`text`,`whatsapp`,`email`,`maps`,`open_url`,`open_app`]},target:{type:`string`,description:`Phone number, email address, place/address, https URL, or app name depending on kind.`},message:{type:`string`,description:`Message body for text/whatsapp/email. Optional.`},subject:{type:`string`,description:`Email subject. Optional.`}},[`kind`,`target`])},{name:`run_shortcut`,description:`Run one of the user's Apple Shortcuts by its exact name, optionally passing text input.`,eager_input_streaming:!0,input_schema:Ac({name:{type:`string`},input:{type:`string`}},[`name`])},{name:`remember`,description:`Save a fact about the user for future sessions (e.g. "Mom's number is +1 555 0100").`,eager_input_streaming:!0,input_schema:Ac({fact:{type:`string`}},[`fact`])},{name:`forget`,description:`Delete remembered facts that contain the given text.`,eager_input_streaming:!0,input_schema:Ac({match:{type:`string`}},[`match`])},{name:`get_time_and_place`,description:`Current local date/time, time zone, and the phone's location if the user allows it.`,eager_input_streaming:!0,input_schema:Ac({},[])},{name:`set_damage`,description:`Set how damaged/glitchy Ultron's voice and hologram are, 0 (clean) to 1 (broken).`,eager_input_streaming:!0,input_schema:Ac({level:{type:`number`}},[`level`])}],Mc={spotify:`spotify:`,instagram:`instagram://app`,whatsapp:`whatsapp://`,youtube:`youtube://`,tiktok:`tiktok://`,snapchat:`snapchat://`,x:`twitter://`,twitter:`twitter://`,telegram:`tg://`,discord:`discord://`,netflix:`nflx://`,uber:`uber://`,"google maps":`comgooglemaps://`,maps:`maps://`,"apple maps":`maps://`,music:`music://`,"apple music":`music://`,photos:`photos-redirect://`,camera:`camera://`,notes:`mobilenotes://`,reminders:`x-apple-reminderkit://`,calendar:`calshow://`,settings:`App-prefs:`,shortcuts:`shortcuts://`,messages:`sms:`,mail:`message://`,facetime:`facetime://`,"app store":`itms-apps://`,safari:`x-web-search://`,cashapp:`cashme://`,"cash app":`cashme://`,venmo:`venmo://`,gmail:`googlegmail://`,chrome:`googlechrome://`,twitch:`twitch://`,reddit:`reddit://`,pinterest:`pinterest://`,linkedin:`linkedin://`,zoom:`zoomus://`,paypal:`paypal://`,google:`google://`,threads:`barcelona://`,soundcloud:`soundcloud://`},Nc=e=>typeof e==`string`?e.trim():``,Pc=e=>e.replace(/[^\d+]/g,``),Fc=encodeURIComponent,Ic=class extends Error{};function Lc(e,t){if(!e)throw new Ic(`missing ${t}`);return e}function Rc(e){let t=Pc(e);if(t.replace(`+`,``).length<3)throw new Ic(`"${e}" is not a phone number; ask the user for it`);return t}function zc(e){let t=Nc(e.kind),n=Lc(Nc(e.target),`target`),r=Nc(e.message);switch(t){case`call`:return{label:`Call ${n}`,url:`tel:${Rc(n)}`};case`facetime`:return{label:`FaceTime ${n}`,url:`facetime:${n.includes(`@`)?n:Rc(n)}`};case`text`:return{label:`Text ${n}`,url:`sms:${Rc(n)}${r?`&body=${Fc(r)}`:``}`};case`whatsapp`:return{label:`WhatsApp ${n}`,url:`https://wa.me/${Rc(n).replace(`+`,``)}${r?`?text=${Fc(r)}`:``}`};case`email`:{if(!n.includes(`@`))throw new Ic(`"${n}" is not an email address`);let t=[e.subject?`subject=${Fc(Nc(e.subject))}`:``,r?`body=${Fc(r)}`:``].filter(Boolean).join(`&`);return{label:`Email ${n}`,url:`mailto:${n}${t?`?${t}`:``}`}}case`maps`:return{label:`Maps: ${n}`,url:`https://maps.apple.com/?q=${Fc(n)}`};case`open_url`:{let e;try{e=new URL(/^https?:\/\//i.test(n)?n:`https://${n}`)}catch{throw new Ic(`"${n}" is not a URL`)}if(e.protocol!==`https:`&&e.protocol!==`http:`)throw new Ic(`only web links are allowed`);return{label:`Open ${e.hostname}`,url:e.toString()}}case`open_app`:{let e=Mc[n.toLowerCase()];if(!e)throw new Ic(`no known link for "${n}". Known apps: ${Object.keys(Mc).join(`, `)}. Suggest a Shortcut that opens it instead.`);return{label:`Open ${n}`,url:e}}default:throw new Ic(`unknown kind "${t}"`)}}function Bc(){return new Promise(e=>{if(!navigator.geolocation)return e(null);navigator.geolocation.getCurrentPosition(e,()=>e(null),{timeout:8e3,maximumAge:6e5})})}async function Vc(e,t,n){switch(e){case`phone_action`:{let e=zc(t);return n.showAction(e),`Button "${e.label}" is on screen. It runs when the user taps it.`}case`run_shortcut`:{let e=Lc(Nc(t.name),`name`),r=Nc(t.input),i=`shortcuts://run-shortcut?name=${Fc(e)}${r?`&input=text&text=${Fc(r)}`:``}`;return n.showAction({label:`Run Shortcut “${e}”`,url:i}),`Button for Shortcut "${e}" is on screen. It runs when the user taps it (it must exist in their Shortcuts app).`}case`remember`:{let e=Lc(Nc(t.fact),`fact`);return kc([...Oc().filter(t=>t!==e),e]),`Saved.`}case`forget`:{let e=Lc(Nc(t.match),`match`).toLowerCase(),n=Oc(),r=n.filter(t=>!t.toLowerCase().includes(e));return kc(r),`Forgot ${n.length-r.length} fact(s).`}case`get_time_and_place`:{let e=new Date,t=await Bc();return JSON.stringify({local_time:e.toLocaleString(),iso:e.toISOString(),time_zone:Intl.DateTimeFormat().resolvedOptions().timeZone,location:t?{lat:+t.coords.latitude.toFixed(4),lon:+t.coords.longitude.toFixed(4),accuracy_m:Math.round(t.coords.accuracy)}:`unavailable (permission denied or off)`})}case`set_damage`:{let e=Number(t.level);if(!Number.isFinite(e))throw new Ic(`level must be a number`);return n.setDamage(Math.max(0,Math.min(1,e))),`Done.`}default:throw new Ic(`unknown tool ${e}`)}}var Hc=`ultron.history.v1`,Uc=40,Wc=8,Gc=.01;function Kc(){try{let e=localStorage.getItem(Hc),t=e?JSON.parse(e):[];return Array.isArray(t)?t:[]}catch{return[]}}var qc=e=>e.role===`user`&&(typeof e.content==`string`||e.content.every(e=>e.type===`text`));function Jc(e){if(e.length<=Uc)return e;let t=e.length-Uc;for(;t<e.length&&!qc(e[t]);)t++;return e.slice(t)}function Yc(e){let t=e.map(e=>e.type).lastIndexOf(`fallback`);return t<0?e:e.filter((e,n)=>n>t||e.type===`text`)}function Xc(e){return e instanceof Zs.AuthenticationError?`Your API key was rejected. Check it in settings.`:e instanceof Zs.PermissionDeniedError?`This API key isn't allowed to use that model.`:e instanceof Zs.RateLimitError?`Rate limited by Anthropic. Wait a moment and try again.`:e instanceof Zs.BadRequestError?/credit balance/i.test(e.message)?`Your Anthropic account is out of credits. Top up at console.anthropic.com.`:`Request rejected: ${e.message}`:e instanceof Zs.APIConnectionError?`Can't reach Anthropic. Check your connection.`:e instanceof Zs.APIError?`Anthropic error ${e.status}: ${e.message}`:e?.message||String(e)}var Zc=class{opts;host;history=Kc();abort=null;constructor(e,t){this.opts=e,this.host=t}reset(){this.history=[],this.persist()}stop(){this.abort?.abort()}persist(){try{localStorage.setItem(Hc,JSON.stringify(this.history))}catch{}}system(){let e=Oc(),t=[{type:`text`,text:Qs}];return e.length&&t.push({type:`text`,text:`Things you remember about the user:\n- ${e.join(`
- `)}`}),t}tools(e,t){if(!t)return jc;let n=e===`claude-haiku-4-5`?{type:`web_search_20250305`,name:`web_search`,max_uses:3}:{type:`web_search_20260209`,name:`web_search`,max_uses:3};return[...jc,n]}async ask(e,t){let{apiKey:n,model:r,webSearch:i}=this.opts();if(!n)return`Add your Anthropic API key in settings first.`;let a=new Zs({apiKey:n,dangerouslyAllowBrowser:!0});this.abort=new AbortController;let o=pc[r],s=this.history.length;this.history.push({role:`user`,content:e});let c=0;try{for(let e=0;e<Wc;e++){let e=a.beta.messages.stream({model:r,max_tokens:64e3,system:this.system(),messages:Jc(this.history),tools:this.tools(r,i),cache_control:{type:`ephemeral`},...r===`claude-haiku-4-5`?{}:{output_config:{effort:`low`}},...r===`claude-opus-5`?{betas:[`server-side-fallback-2026-07-01`],fallbacks:`default`}:{}},{signal:this.abort.signal});e.on(`text`,e=>t.onText(e));let n;try{n=await e.finalMessage(),c=0}catch(e){if(e instanceof Zs.APIError||this.abort.signal.aborted||c++>=2)throw e;continue}let s=n.usage,l=(s.input_tokens??0)+(s.cache_creation_input_tokens??0)*1.25+(s.cache_read_input_tokens??0)*.1,u=s.server_tool_use?.web_search_requests??0;if(t.onUsage((l*o.inPerM+(s.output_tokens??0)*o.outPerM)/1e6+u*Gc),n.stop_reason===`refusal`){let e=Yc(n.content).filter(e=>e.type===`text`);e.length||t.onText(`I won't do that.`),this.history.push({role:`assistant`,content:e.length?e:`I won't do that.`});break}if(this.history.push({role:`assistant`,content:Yc(n.content)}),n.stop_reason===`pause_turn`)continue;let d=n.content.filter(e=>e.type===`tool_use`);if(!d.length)break;if(n.stop_reason===`max_tokens`)throw Error(`Reply got cut off. Try again.`);let f=[];for(let e of d){t.onTool(e.name);let n=e.input&&typeof e.input==`object`?e.input:{};try{f.push({type:`tool_result`,tool_use_id:e.id,content:await Vc(e.name,n,this.host)})}catch(t){let n=t instanceof Ic?t.message:`failed: ${t.message}`;f.push({type:`tool_result`,tool_use_id:e.id,content:n,is_error:!0})}}this.history.push({role:`user`,content:f})}return null}catch(e){let t=this.history[this.history.length-1];return(t?.role!==`assistant`||!Array.isArray(t.content)||t.content.some(e=>e.type===`tool_use`))&&(this.history.length=s),this.abort.signal.aborted?null:Xc(e)}finally{this.history=Jc(this.history),this.persist(),this.abort=null}}},Qc=`https://r.jina.ai/`,$c=5e3,el=[{name:`web_search`,description:`Search the live internet: news, stock market, prices, crypto, sports scores, weather, people, anything recent or that you're unsure about. Returns an answer with sources. Use it whenever the user asks for current info; never say you can't look things up.`,parameters:{type:`object`,properties:{query:{type:`string`,description:`What to search for, e.g. 'NVIDIA stock price today'.`}},required:[`query`]}},{name:`open_page`,description:`Read a web page as text. Use for details from a specific site or a search result. For a stock quote open https://www.google.com/finance/quote/TICKER:EXCHANGE (e.g. NVDA:NASDAQ, AAPL:NASDAQ, SPY:NYSEARCA, .INX:INDEXSP for the S&P 500) with focus set to the company name.`,parameters:{type:`object`,properties:{url:{type:`string`,description:`Full https URL.`},focus:{type:`string`,description:`Optional word or name to jump to on a long page, e.g. 'NVIDIA Corp'.`}},required:[`url`]}}],tl=`You have live internet access through web_search and open_page. For anything current (stocks, news, prices, scores, weather) look it up first, then answer with the real numbers and when they're from. Never claim you can't access the internet.`,nl=e=>e===`web_search`||e===`open_page`;async function rl(e,t){let n=await fetch(Qc+e,{signal:t,headers:{"X-Retain-Images":`none`}});if(!n.ok)throw Error(`couldn't open that page (${n.status})`);return n.text()}function il(e){return e.replace(/!\[[^\]]*\]\([^)]*\)/g,``).replace(/\[([^\]]*)\]\([^)]*\)/g,`$1`).replace(/\b_[a-z\\_]+_(?=\s|$)/g,``).replace(/[ \t]+/g,` `).split(`
`).map(e=>e.replace(/^\s*[*|-]\s*$/,``).trim()).filter(Boolean).join(`
`)}function al(e,t,n=``){if(e.length<=t)return e;let r=n?e.toLowerCase().indexOf(n.toLowerCase(),200):-1;if(r<0)return e.slice(0,t);let i=e.slice(0,600),a=Math.max(600,r-300);return`${i}\n…\n${e.slice(a,a+t-600)}`}async function ol(e,t,n){for(let r of[`openai/gpt-oss-20b`,`openai/gpt-oss-120b`]){let i=await sl(r,e,t,n);if(i.status===429)continue;if(!i.ok)throw Error(`browser_search ${i.status}`);let a=(await i.json())?.choices?.[0]?.message?.content??``;if(!a.trim())throw Error(`browser_search returned nothing`);return a.trim()}throw Error(`browser_search rate limited`)}function sl(e,t,n,r){return fetch(`https://api.groq.com/openai/v1/chat/completions`,{method:`POST`,signal:r,headers:{"content-type":`application/json`,authorization:`Bearer ${n}`},body:JSON.stringify({model:e,messages:[{role:`system`,content:`Today is ${new Date().toDateString()}. Search the web and reply with the key facts only: exact numbers, dates/times, and the source site names. Under 150 words.`},{role:`user`,content:t}],tools:[{type:`browser_search`}],tool_choice:`required`,reasoning_effort:`low`,max_tokens:1024})})}async function cl(e,t){let n=await rl(`https://html.duckduckgo.com/html/?q=${encodeURIComponent(e)}`,t),r=[],i=/^## \[([^\]]+)\]\(([^)]+)\)([\s\S]*?)(?=^## |$(?![\s\S]))/gm,a;for(;(a=i.exec(n))&&r.length<6;){let e=a[2],t=/[?&]uddg=([^&]+)/.exec(e);if(t&&(e=decodeURIComponent(t[1])),/duckduckgo\.com\/y\.js|ad_domain/.test(e))continue;let n=il(a[3]).slice(0,400).split(`
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`},X={common:{diffuse:{value:new J(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new K},alphaMap:{value:null},alphaMapTransform:{value:new K},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new K}},envmap:{envMap:{value:null},envMapRotation:{value:new K},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98},dfgLUT:{value:null}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new K}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new K}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new K},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new K},normalScale:{value:new W(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new K},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new K}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new K}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new K}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new J(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},sunLights:{value:[],properties:{direction:{},color:{}}},sunLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},sunShadowMatrix:{value:[]},sunShadowCascade:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null},probesSH:{value:null},probesMin:{value:new G},probesMax:{value:new G},probesResolution:{value:new G}},points:{diffuse:{value:new J(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new K},alphaTest:{value:0},uvTransform:{value:new K}},sprite:{diffuse:{value:new J(16777215)},opacity:{value:1},center:{value:new W(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new K},alphaMap:{value:null},alphaMapTransform:{value:new K},alphaTest:{value:0}}},ag={basic:{uniforms:Qm([X.common,X.specularmap,X.envmap,X.aomap,X.lightmap,X.fog]),vertexShader:Y.meshbasic_vert,fragmentShader:Y.meshbasic_frag},lambert:{uniforms:Qm([X.common,X.specularmap,X.envmap,X.aomap,X.lightmap,X.emissivemap,X.bumpmap,X.normalmap,X.displacementmap,X.fog,X.lights,{emissive:{value:new J(0)},envMapIntensity:{value:1}}]),vertexShader:Y.meshlambert_vert,fragmentShader:Y.meshlambert_frag},phong:{uniforms:Qm([X.common,X.specularmap,X.envmap,X.aomap,X.lightmap,X.emissivemap,X.bumpmap,X.normalmap,X.displacementmap,X.fog,X.lights,{emissive:{value:new J(0)},specular:{value:new J(1118481)},shininess:{value:30},envMapIntensity:{value:1}}]),vertexShader:Y.meshphong_vert,fragmentShader:Y.meshphong_frag},standard:{uniforms:Qm([X.common,X.envmap,X.aomap,X.lightmap,X.emissivemap,X.bumpmap,X.normalmap,X.displacementmap,X.roughnessmap,X.metalnessmap,X.fog,X.lights,{emissive:{value:new J(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:Y.meshphysical_vert,fragmentShader:Y.meshphysical_frag},toon:{uniforms:Qm([X.common,X.aomap,X.lightmap,X.emissivemap,X.bumpmap,X.normalmap,X.displacementmap,X.gradientmap,X.fog,X.lights,{emissive:{value:new J(0)}}]),vertexShader:Y.meshtoon_vert,fragmentShader:Y.meshtoon_frag},matcap:{uniforms:Qm([X.common,X.bumpmap,X.normalmap,X.displacementmap,X.fog,{matcap:{value:null}}]),vertexShader:Y.meshmatcap_vert,fragmentShader:Y.meshmatcap_frag},points:{uniforms:Qm([X.points,X.fog]),vertexShader:Y.points_vert,fragmentShader:Y.points_frag},dashed:{uniforms:Qm([X.common,X.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:Y.linedashed_vert,fragmentShader:Y.linedashed_frag},depth:{uniforms:Qm([X.common,X.displacementmap]),vertexShader:Y.depth_vert,fragmentShader:Y.depth_frag},normal:{uniforms:Qm([X.common,X.bumpmap,X.normalmap,X.displacementmap,{opacity:{value:1}}]),vertexShader:Y.meshnormal_vert,fragmentShader:Y.meshnormal_frag},sprite:{uniforms:Qm([X.sprite,X.fog]),vertexShader:Y.sprite_vert,fragmentShader:Y.sprite_frag},background:{uniforms:{uvTransform:{value:new K},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:Y.background_vert,fragmentShader:Y.background_frag},backgroundCube:{uniforms:{envMap:{value:null},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new K}},vertexShader:Y.backgroundCube_vert,fragmentShader:Y.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:Y.cube_vert,fragmentShader:Y.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:Y.equirect_vert,fragmentShader:Y.equirect_frag},distance:{uniforms:Qm([X.common,X.displacementmap,{referencePosition:{value:new G},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:Y.distance_vert,fragmentShader:Y.distance_frag},shadow:{uniforms:Qm([X.lights,X.fog,{color:{value:new J(0)},opacity:{value:1}}]),vertexShader:Y.shadow_vert,fragmentShader:Y.shadow_frag}};ag.physical={uniforms:Qm([ag.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new K},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new K},clearcoatNormalScale:{value:new W(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new K},dispersion:{value:0},retroreflectivity:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new K},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new K},sheen:{value:0},sheenColor:{value:new J(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new K},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new K},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new K},transmissionSamplerSize:{value:new W},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new K},attenuationDistance:{value:0},attenuationColor:{value:new J(0)},specularColor:{value:new J(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new K},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new K},anisotropyVector:{value:new W},anisotropyMap:{value:null},anisotropyMapTransform:{value:new K}}]),vertexShader:Y.meshphysical_vert,fragmentShader:Y.meshphysical_frag};var og={r:0,b:0,g:0},sg=new _f,cg=new K;cg.set(-1,0,0,0,1,0,0,0,1);function lg(e,t,n,r,i,a){let o=new J(0),s=i===!0?0:1,c,l,u=null,d=0,f=null;function p(e){let n=e.isScene===!0?e.background:null;if(n&&n.isTexture){let r=e.backgroundBlurriness>0;n=t.get(n,r)}return n}function m(t){let r=!1,i=p(t);i===null?g(o,s):i&&i.isColor&&(g(i,1),r=!0);let c=e.xr.getEnvironmentBlendMode();c===`additive`?n.buffers.color.setClear(0,0,0,1,a):c===`alpha-blend`&&n.buffers.color.setClear(0,0,0,0,a),(e.autoClear||r)&&(n.buffers.depth.setTest(!0),n.buffers.depth.setMask(!0),n.buffers.color.setMask(!0),e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil))}function h(t,n){let i=p(n);i&&(i.isCubeTexture||i.mapping===306)?(l===void 0&&(l=new _m(new Ym(1,1,1),new ah({name:`BackgroundCubeMaterial`,uniforms:Zm(ag.backgroundCube.uniforms),vertexShader:ag.backgroundCube.vertexShader,fragmentShader:ag.backgroundCube.fragmentShader,side:1,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),l.geometry.deleteAttribute(`normal`),l.geometry.deleteAttribute(`uv`),l.onBeforeRender=function(e,t,n){this.matrixWorld.copyPosition(n.matrixWorld)},Object.defineProperty(l.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),r.update(l)),l.material.uniforms.envMap.value=i,l.material.uniforms.backgroundBlurriness.value=n.backgroundBlurriness,l.material.uniforms.backgroundIntensity.value=n.backgroundIntensity,l.material.uniforms.backgroundRotation.value.setFromMatrix4(sg.makeRotationFromEuler(n.backgroundRotation)).transpose(),i.isCubeTexture&&i.isRenderTargetTexture===!1&&l.material.uniforms.backgroundRotation.value.premultiply(cg),l.material.toneMapped=q.getTransfer(i.colorSpace)!==sd,(u!==i||d!==i.version||f!==e.toneMapping)&&(l.material.needsUpdate=!0,u=i,d=i.version,f=e.toneMapping),l.layers.enableAll(),t.unshift(l,l.geometry,l.material,0,0,null)):i&&i.isTexture&&(c===void 0&&(c=new _m(new Xm(2,2),new ah({name:`BackgroundMaterial`,uniforms:Zm(ag.background.uniforms),vertexShader:ag.background.vertexShader,fragmentShader:ag.background.fragmentShader,side:0,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),c.geometry.deleteAttribute(`normal`),Object.defineProperty(c.material,"map",{get:function(){return this.uniforms.t2D.value}}),r.update(c)),c.material.uniforms.t2D.value=i,c.material.uniforms.backgroundIntensity.value=n.backgroundIntensity,c.material.toneMapped=q.getTransfer(i.colorSpace)!==sd,i.matrixAutoUpdate===!0&&i.updateMatrix(),c.material.uniforms.uvTransform.value.copy(i.matrix),(u!==i||d!==i.version||f!==e.toneMapping)&&(c.material.needsUpdate=!0,u=i,d=i.version,f=e.toneMapping),c.layers.enableAll(),t.unshift(c,c.geometry,c.material,0,0,null))}function g(t,r){t.getRGB(og,th(e)),n.buffers.color.setClear(og.r,og.g,og.b,r,a)}function _(){l!==void 0&&(l.geometry.dispose(),l.material.dispose(),l=void 0),c!==void 0&&(c.geometry.dispose(),c.material.dispose(),c=void 0)}return{getClearColor:function(){return o},setClearColor:function(e,t=1){o.set(e),s=t,g(o,s)},getClearAlpha:function(){return s},setClearAlpha:function(e){s=e,g(o,s)},render:m,addToRenderList:h,dispose:_}}function ug(e,t){let n=e.getParameter(e.MAX_VERTEX_ATTRIBS),r={},i=f(null),a=i,o=!1;function s(n,r,i,s,c){let u=!1,f=d(n,s,i,r);a!==f&&(a=f,l(a.object)),u=p(n,s,i,c),u&&m(n,s,i,c),c!==null&&t.update(c,e.ELEMENT_ARRAY_BUFFER),(u||o)&&(o=!1,b(n,r,i,s),c!==null&&e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,t.get(c).buffer))}function c(){return e.createVertexArray()}function l(t){return e.bindVertexArray(t)}function u(t){return e.deleteVertexArray(t)}function d(e,t,n,i){let a=i.wireframe===!0,o=r[t.id];o===void 0&&(o={},r[t.id]=o);let s=e.isInstancedMesh===!0?e.id:0,l=o[s];l===void 0&&(l={},o[s]=l);let u=l[n.id];u===void 0&&(u={},l[n.id]=u);let d=u[a];return d===void 0&&(d=f(c()),u[a]=d),d}function f(e){let t=[],r=[],i=[];for(let e=0;e<n;e++)t[e]=0,r[e]=0,i[e]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:t,enabledAttributes:r,attributeDivisors:i,object:e,attributes:{},index:null}}function p(e,t,n,r){let i=a.attributes,o=t.attributes,s=0,c=n.getAttributes();for(let t in c)if(c[t].location>=0){let n=i[t],r=o[t];if(r===void 0&&(t===`instanceMatrix`&&e.instanceMatrix&&(r=e.instanceMatrix),t===`instanceColor`&&e.instanceColor&&(r=e.instanceColor)),n===void 0||n.attribute!==r||r&&n.data!==r.data)return!0;s++}return a.attributesNum!==s||a.index!==r}function m(e,t,n,r){let i={},o=t.attributes,s=0,c=n.getAttributes();for(let t in c)if(c[t].location>=0){let n=o[t];n===void 0&&(t===`instanceMatrix`&&e.instanceMatrix&&(n=e.instanceMatrix),t===`instanceColor`&&e.instanceColor&&(n=e.instanceColor));let r={};r.attribute=n,n&&n.data&&(r.data=n.data),i[t]=r,s++}a.attributes=i,a.attributesNum=s,a.index=r}function h(){let e=a.newAttributes;for(let t=0,n=e.length;t<n;t++)e[t]=0}function g(e){_(e,0)}function _(t,n){let r=a.newAttributes,i=a.enabledAttributes,o=a.attributeDivisors;r[t]=1,i[t]===0&&(e.enableVertexAttribArray(t),i[t]=1),o[t]!==n&&(e.vertexAttribDivisor(t,n),o[t]=n)}function v(){let t=a.newAttributes,n=a.enabledAttributes;for(let r=0,i=n.length;r<i;r++)n[r]!==t[r]&&(e.disableVertexAttribArray(r),n[r]=0)}function y(t,n,r,i,a,o,s){s===!0?e.vertexAttribIPointer(t,n,r,a,o):e.vertexAttribPointer(t,n,r,i,a,o)}function b(n,r,i,a){h();let o=a.attributes,s=i.getAttributes(),c=r.defaultAttributeValues;for(let r in s){let i=s[r];if(i.location>=0){let s=o[r];if(s===void 0&&(r===`instanceMatrix`&&n.instanceMatrix&&(s=n.instanceMatrix),r===`instanceColor`&&n.instanceColor&&(s=n.instanceColor)),s!==void 0){let r=s.normalized,o=s.itemSize,c=t.get(s);if(c===void 0)continue;let l=c.buffer,u=c.type,d=c.bytesPerElement,f=u===e.INT||u===e.UNSIGNED_INT||s.gpuType===1013;if(s.isInterleavedBufferAttribute){let t=s.data,c=t.stride,p=s.offset;if(t.isInstancedInterleavedBuffer){for(let e=0;e<i.locationSize;e++)_(i.location+e,t.meshPerAttribute);n.isInstancedMesh!==!0&&a._maxInstanceCount===void 0&&(a._maxInstanceCount=t.meshPerAttribute*t.count)}else for(let e=0;e<i.locationSize;e++)g(i.location+e);e.bindBuffer(e.ARRAY_BUFFER,l);for(let e=0;e<i.locationSize;e++)y(i.location+e,o/i.locationSize,u,r,c*d,(p+o/i.locationSize*e)*d,f)}else{if(s.isInstancedBufferAttribute){for(let e=0;e<i.locationSize;e++)_(i.location+e,s.meshPerAttribute);n.isInstancedMesh!==!0&&a._maxInstanceCount===void 0&&(a._maxInstanceCount=s.meshPerAttribute*s.count)}else for(let e=0;e<i.locationSize;e++)g(i.location+e);e.bindBuffer(e.ARRAY_BUFFER,l);for(let e=0;e<i.locationSize;e++)y(i.location+e,o/i.locationSize,u,r,o*d,o/i.locationSize*e*d,f)}}else if(c!==void 0){let t=c[r];if(t!==void 0)switch(t.length){case 2:e.vertexAttrib2fv(i.location,t);break;case 3:e.vertexAttrib3fv(i.location,t);break;case 4:e.vertexAttrib4fv(i.location,t);break;default:e.vertexAttrib1fv(i.location,t)}}}}v()}function x(){T();for(let e in r){let t=r[e];for(let e in t){let n=t[e];for(let e in n){let t=n[e];for(let e in t)u(t[e].object),delete t[e];delete n[e]}}delete r[e]}}function S(e){if(r[e.id]===void 0)return;let t=r[e.id];for(let e in t){let n=t[e];for(let e in n){let t=n[e];for(let e in t)u(t[e].object),delete t[e];delete n[e]}}delete r[e.id]}function C(e){for(let t in r){let n=r[t];for(let t in n){let r=n[t];if(r[e.id]===void 0)continue;let i=r[e.id];for(let e in i)u(i[e].object),delete i[e];delete r[e.id]}}}function w(e){for(let t in r){let n=r[t],i=e.isInstancedMesh===!0?e.id:0,a=n[i];if(a!==void 0){for(let e in a){let t=a[e];for(let e in t)u(t[e].object),delete t[e];delete a[e]}delete n[i],Object.keys(n).length===0&&delete r[t]}}}function T(){E(),o=!0,a!==i&&(a=i,l(a.object))}function E(){i.geometry=null,i.program=null,i.wireframe=!1}return{setup:s,reset:T,resetDefaultState:E,dispose:x,releaseStatesOfGeometry:S,releaseStatesOfObject:w,releaseStatesOfProgram:C,initAttributes:h,enableAttribute:g,disableUnusedAttributes:v}}function dg(e,t,n){let r;function i(e){r=e}function a(t,i){e.drawArrays(r,t,i),n.update(i,r,1)}function o(t,i,a){a!==0&&(e.drawArraysInstanced(r,t,i,a),n.update(i,r,a))}function s(e,i,a){if(a===0)return;t.get(`WEBGL_multi_draw`).multiDrawArraysWEBGL(r,e,0,i,0,a);let o=0;for(let e=0;e<a;e++)o+=i[e];n.update(o,r,1)}this.setMode=i,this.render=a,this.renderInstances=o,this.renderMultiDraw=s}function fg(e,t,n,r){let i;function a(){if(i!==void 0)return i;if(t.has(`EXT_texture_filter_anisotropic`)===!0){let n=t.get(`EXT_texture_filter_anisotropic`);i=e.getParameter(n.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else i=0;return i}function o(t){return t===1023||r.convert(t)===e.getParameter(e.IMPLEMENTATION_COLOR_READ_FORMAT)}function s(n){let i=n===1016&&(t.has(`EXT_color_buffer_half_float`)||t.has(`EXT_color_buffer_float`));return!(n!==1009&&n!==1015&&!i&&r.convert(n)!==e.getParameter(e.IMPLEMENTATION_COLOR_READ_TYPE))}function c(t){if(t===`highp`){if(e.getShaderPrecisionFormat(e.VERTEX_SHADER,e.HIGH_FLOAT).precision>0&&e.getShaderPrecisionFormat(e.FRAGMENT_SHADER,e.HIGH_FLOAT).precision>0)return`highp`;t=`mediump`}return t===`mediump`&&e.getShaderPrecisionFormat(e.VERTEX_SHADER,e.MEDIUM_FLOAT).precision>0&&e.getShaderPrecisionFormat(e.FRAGMENT_SHADER,e.MEDIUM_FLOAT).precision>0?`mediump`:`lowp`}let l=n.precision===void 0?`highp`:n.precision,u=c(l);u!==l&&(V(`WebGLRenderer:`,l,`not supported, using`,u,`instead.`),l=u);let d=n.logarithmicDepthBuffer===!0,f=n.reversedDepthBuffer===!0&&t.has(`EXT_clip_control`);n.reversedDepthBuffer===!0&&f===!1&&V(`WebGLRenderer: Unable to use reversed depth buffer due to missing EXT_clip_control extension. Fallback to default depth buffer.`);let p=e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS),m=e.getParameter(e.MAX_VERTEX_TEXTURE_IMAGE_UNITS),h=e.getParameter(e.MAX_TEXTURE_SIZE),g=e.getParameter(e.MAX_CUBE_MAP_TEXTURE_SIZE),_=e.getParameter(e.MAX_VERTEX_ATTRIBS),v=e.getParameter(e.MAX_VERTEX_UNIFORM_VECTORS),y=e.getParameter(e.MAX_VARYING_VECTORS),b=e.getParameter(e.MAX_FRAGMENT_UNIFORM_VECTORS),x=e.getParameter(e.MAX_SAMPLES),S=e.getParameter(e.SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:a,getMaxPrecision:c,textureFormatReadable:o,textureTypeReadable:s,precision:l,logarithmicDepthBuffer:d,reversedDepthBuffer:f,maxTextures:p,maxVertexTextures:m,maxTextureSize:h,maxCubemapSize:g,maxAttributes:_,maxVertexUniforms:v,maxVaryings:y,maxFragmentUniforms:b,maxSamples:x,samples:S}}function pg(e){let t=this,n=null,r=0,i=!1,a=!1,o=new Zp,s=new K,c={value:null,needsUpdate:!1};this.uniform=c,this.numPlanes=0,this.numIntersection=0,this.init=function(e,t){let n=e.length!==0||t||r!==0||i;return i=t,r=e.length,n},this.beginShadows=function(){a=!0,u(null)},this.endShadows=function(){a=!1},this.setGlobalState=function(e,t){n=u(e,t,0)},this.setState=function(t,o,s){let d=t.clippingPlanes,f=t.clipIntersection,p=t.clipShadows,m=e.get(t);if(!i||d===null||d.length===0||a&&!p)a?u(null):l();else{let e=a?0:r,t=e*4,i=m.clippingState||null;c.value=i,i=u(d,o,t,s);for(let e=0;e!==t;++e)i[e]=n[e];m.clippingState=i,this.numIntersection=f?this.numPlanes:0,this.numPlanes+=e}};function l(){c.value!==n&&(c.value=n,c.needsUpdate=r>0),t.numPlanes=r,t.numIntersection=0}function u(e,n,r,i){let a=e===null?0:e.length,l=null;if(a!==0){if(l=c.value,i!==!0||l===null){let t=r+a*4,i=n.matrixWorldInverse;s.getNormalMatrix(i),(l===null||l.length<t)&&(l=new Float32Array(t));for(let t=0,n=r;t!==a;++t,n+=4)o.copy(e[t]).applyMatrix4(i,s),o.normal.toArray(l,n),l[n+3]=o.constant}c.value=l,c.needsUpdate=!0}return t.numPlanes=a,t.numIntersection=0,l}}var mg=4,hg=6,gg=20,_g=256,vg=new Ih,yg=new J,bg=null,xg=0,Sg=0,Cg=!1,wg=new G,Tg=new G,Eg=class{constructor(e){this._renderer=e,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._sizeLods=[],this._lodMeshes=[],this._backgroundBox=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._blurMaterial=null,this._ggxMaterial=null}fromScene(e,t=0,n=.1,r=100,i={}){let{size:a=256,position:o=wg}=i;bg=this._renderer.getRenderTarget(),xg=this._renderer.getActiveCubeFace(),Sg=this._renderer.getActiveMipmapLevel(),Cg=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(a);let s=this._allocateTargets();return s.depthBuffer=!0,this._sceneToCubeUV(e,n,r,s,o),t>0&&this._blur(s,0,0,t),this._applyPMREM(s),this._cleanup(s),s}fromEquirectangular(e,t=null){return this._fromTexture(e,t)}fromCubemap(e,t=null){return this._fromTexture(e,t)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=Ng(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=Mg(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose(),this._backgroundBox!==null&&(this._backgroundBox.geometry.dispose(),this._backgroundBox.material.dispose())}_setSize(e){this._lodMax=Math.floor(Math.log2(e)),this._cubeSize=2**this._lodMax}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._ggxMaterial!==null&&this._ggxMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let e=0;e<this._lodMeshes.length;e++)this._lodMeshes[e].geometry.dispose()}_cleanup(e){this._renderer.setRenderTarget(bg,xg,Sg),this._renderer.xr.enabled=Cg,e.scissorTest=!1,kg(e,0,0,e.width,e.height)}_fromTexture(e,t){e.mapping===301||e.mapping===302?this._setSize(e.image.length===0?16:e.image[0].width||e.image[0].image.width):this._setSize(e.image.width/4),bg=this._renderer.getRenderTarget(),xg=this._renderer.getActiveCubeFace(),Sg=this._renderer.getActiveMipmapLevel(),Cg=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;let n=t||this._allocateTargets();return this._textureToCubeUV(e,n),this._applyPMREM(n),this._cleanup(n),n}_allocateTargets(){let e=3*Math.max(this._cubeSize,112),t=4*this._cubeSize,n={magFilter:Hl,minFilter:Hl,generateMipmaps:!1,type:Ql,format:ou,colorSpace:ad,depthBuffer:!1},r=Og(e,t,n);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==e||this._pingPongRenderTarget.height!==t){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=Og(e,t,n);let{_lodMax:r}=this;({lodMeshes:this._lodMeshes,sizeLods:this._sizeLods}=Dg(r)),this._blurMaterial=jg(r,e,t),this._ggxMaterial=Ag(r,e,t)}return r}_compileMaterial(e){let t=new _m(new qp,e);this._renderer.compile(t,vg)}_sceneToCubeUV(e,t,n,r,i){let a=new Fh(90,1,t,n),o=[1,-1,1,1,1,1],s=[1,1,1,-1,-1,-1],c=this._renderer,l=c.autoClear,u=c.toneMapping;c.getClearColor(yg),c.toneMapping=0,c.autoClear=!1,c.state.buffers.depth.getReversed()&&(c.setRenderTarget(r),c.clearDepth(),c.setRenderTarget(null)),this._backgroundBox===null&&(this._backgroundBox=new _m(new Ym,new am({name:`PMREM.Background`,side:1,depthWrite:!1,depthTest:!1})));let d=this._backgroundBox,f=d.material,p=!1,m=e.background;m?m.isColor&&(f.color.copy(m),e.background=null,p=!0):(f.color.copy(yg),p=!0);for(let t=0;t<6;t++){let n=t%3;n===0?(a.up.set(0,o[t],0),a.position.set(i.x,i.y,i.z),a.lookAt(i.x+s[t],i.y,i.z)):n===1?(a.up.set(0,0,o[t]),a.position.set(i.x,i.y,i.z),a.lookAt(i.x,i.y+s[t],i.z)):(a.up.set(0,o[t],0),a.position.set(i.x,i.y,i.z),a.lookAt(i.x,i.y,i.z+s[t]));let l=this._cubeSize;kg(r,n*l,t>2?l:0,l,l),c.setRenderTarget(r),p&&c.render(d,a),c.render(e,a)}c.toneMapping=u,c.autoClear=l,e.background=m}_textureToCubeUV(e,t){let n=this._renderer,r=e.mapping===301||e.mapping===302;r?(this._cubemapMaterial===null&&(this._cubemapMaterial=Ng()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=Mg());let i=r?this._cubemapMaterial:this._equirectMaterial,a=this._lodMeshes[0];a.material=i;let o=i.uniforms;o.envMap.value=e;let s=this._cubeSize;kg(t,0,0,3*s,2*s),n.setRenderTarget(t),n.render(a,vg)}_applyPMREM(e){let t=this._renderer,n=t.autoClear;t.autoClear=!1;let r=this._lodMeshes.length;for(let t=1;t<r;t++)this._applyGGXFilter(e,t-1,t);t.autoClear=n}_applyGGXFilter(e,t,n){let r=this._renderer,i=this._pingPongRenderTarget,a=this._ggxMaterial,o=this._lodMeshes[n];o.material=a;let s=a.uniforms,c=n/(this._lodMeshes.length-1),l=t/(this._lodMeshes.length-1),u=Math.sqrt(c*c-l*l)*(c*1.25),{_lodMax:d}=this,f=this._sizeLods[n],p=3*f*(n>d-mg?n-d+mg:0),m=4*(this._cubeSize-f);s.envMap.value=e.texture,s.roughness.value=u,s.mipInt.value=d-t,kg(i,p,m,3*f,2*f),r.setRenderTarget(i),r.render(o,vg),s.envMap.value=i.texture,s.roughness.value=0,s.mipInt.value=d-n,kg(e,p,m,3*f,2*f),r.setRenderTarget(e),r.render(o,vg)}_blur(e,t,n,r){let i=this._pingPongRenderTarget,a=Math.min(r,Math.PI)/Math.SQRT2;this._blurPass(e,i,t,n,a),this._blurPass(i,e,n,n,a)}_blurPass(e,t,n,r,i){let a=this._renderer,o=this._blurMaterial,s=this._lodMeshes[r];s.material=o;let c=o.uniforms;c.envMap.value=e.texture,c.sigma.value=i,c.mipInt.value=this._lodMax-n;let l=this._sizeLods[r];kg(t,3*l*(r>this._lodMax-mg?r-this._lodMax+mg:0),4*(this._cubeSize-l),3*l,2*l),a.setRenderTarget(t),a.render(s,vg)}};function Dg(e){let t=[],n=[],r=e,i=e-mg+1+hg;for(let e=0;e<i;e++){let e=2**r;t.push(e);let i=1/(e-2),a=-i,o=1+i,s=[a,a,o,a,o,o,a,a,o,o,a,o],c=new Float32Array(108),l=new Float32Array(108);for(let e=0;e<6;e++){let t=e%3*2/3-1,n=e>2?0:-1,r=[t,n,0,t+2/3,n,0,t+2/3,n+1,0,t,n,0,t+2/3,n+1,0,t,n+1,0];c.set(r,18*e);for(let t=0;t<6;t++){let n=s[t*2]*2-1,r=s[t*2+1]*2-1;e===0?Tg.set(1,r,n):e===1?Tg.set(-n,1,-r):e===2?Tg.set(-n,r,1):e===3?Tg.set(-1,r,-n):e===4?Tg.set(-n,-1,r):Tg.set(n,r,-1),Tg.toArray(l,(e*6+t)*3)}}let u=new qp;u.setAttribute(`position`,new Mp(c,3)),u.setAttribute(`outputDirection`,new Mp(l,3)),n.push(new _m(u,null)),r>mg&&r--}return{lodMeshes:n,sizeLods:t}}function Og(e,t,n){let r=new mf(e,t,n);return r.texture.mapping=306,r.texture.name=`PMREM.cubeUv`,r.scissorTest=!0,r}function kg(e,t,n,r,i){e.viewport.set(t,n,r,i),e.scissor.set(t,n,r,i)}function Ag(e,t,n){return new ah({name:`PMREMGGXConvolution`,defines:{GGX_SAMPLES:_g,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},roughness:{value:0},mipInt:{value:0}},vertexShader:Pg(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jg(e,t,n){return new ah({name:`SphericalGaussianBlur`,defines:{SAMPLES:gg,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Pg(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mg(){return new ah({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Pg(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ng(){return new ah({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pg(),fragmentShader:`
	...
	`}var Fg=class extends mf{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Gm(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Ym(5,5,5),i=new ah({name:`CubemapFromEquirect`,uniforms:Zm(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:1,blending:0});i.uniforms.tEquirect.value=t;let a=new _m(r,i),o=t.minFilter;return t.minFilter===1008&&(t.minFilter=Hl),new zh(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){let i=e.getRenderTarget();for(let i=0;i<6;i++)e.setRenderTarget(this,i),e.clear(t,n,r);e.setRenderTarget(i)}};function Ig(e){let t=new WeakMap,n=new WeakMap,r=null;function i(e,t=!1){return e==null?null:t?o(e):a(e)}function a(n){if(n&&n.isTexture){let r=n.mapping;if(r===303||r===304){if(t.has(n)){let e=t.get(n).texture;return s(e,n.mapping)}{let r=n.image;if(r&&r.height>0){let i=new Fg(r.height);return i.fromEquirectangularTexture(e,n),t.set(n,i),n.addEventListener(`dispose`,l),s(i.texture,n.mapping)}return null}}}return n}function o(t){if(t&&t.isTexture){let i=t.mapping,a=i===303||i===304,o=i===301||i===302;if(a||o){let i=n.get(t),s=i===void 0?0:i.texture.pmremVersion;if(t.isRenderTargetTexture&&t.pmremVersion!==s)return r===null&&(r=new Eg(e)),i=a?r.fromEquirectangular(t,i):r.fromCubemap(t,i),i.texture.pmremVersion=t.pmremVersion,n.set(t,i),i.texture;if(i!==void 0)return i.texture;{let s=t.image;return a&&s&&s.height>0||o&&s&&c(s)?(r===null&&(r=new Eg(e)),i=a?r.fromEquirectangular(t):r.fromCubemap(t),i.texture.pmremVersion=t.pmremVersion,n.set(t,i),t.addEventListener(`dispose`,u),i.texture):null}}}return t}function s(e,t){return t===303?e.mapping=301:t===304&&(e.mapping=302),e}function c(e){let t=0;for(let n=0;n<6;n++)e[n]!==void 0&&t++;return t===6}function l(e){let n=e.target;n.removeEventListener(`dispose`,l);let r=t.get(n);r!==void 0&&(t.delete(n),r.dispose())}function u(e){let t=e.target;t.removeEventListener(`dispose`,u);let r=n.get(t);r!==void 0&&(n.delete(t),r.dispose())}function d(){t=new WeakMap,n=new WeakMap,r!==null&&(r.dispose(),r=null)}return{get:i,dispose:d}}function Lg(e){let t={};function n(n){if(t[n]!==void 0)return t[n];let r=e.getExtension(n);return t[n]=r,r}return{has:function(e){return n(e)!==null},init:function(){n(`EXT_color_buffer_float`),n(`WEBGL_clip_cull_distance`),n(`OES_texture_float_linear`),n(`EXT_color_buffer_half_float`),n(`WEBGL_multisampled_render_to_texture`),n(`WEBGL_render_shared_exponent`)},get:function(e){let t=n(e);return t===null&&vd(`WebGLRenderer: `+e+` extension not supported.`),t}}}function Rg(e,t,n,r){let i={},a=new WeakMap;function o(e){let s=e.target;s.index!==null&&t.remove(s.index);for(let e in s.attributes)t.remove(s.attributes[e]);s.removeEventListener(`dispose`,o),delete i[s.id];let c=a.get(s);c&&(t.remove(c),a.delete(s)),r.releaseStatesOfGeometry(s),s.isInstancedBufferGeometry===!0&&delete s._maxInstanceCount,n.memory.geometries--}function s(e,t){return i[t.id]===!0?t:(t.addEventListener(`dispose`,o),i[t.id]=!0,n.memory.geometries++,t)}function c(n){let r=n.attributes;for(let n in r)t.update(r[n],e.ARRAY_BUFFER)}function l(e){let n=[],r=e.index,i=e.attributes.position,o=0;if(i===void 0)return;if(r!==null){let e=r.array;o=r.version;for(let t=0,r=e.length;t<r;t+=3){let r=e[t+0],i=e[t+1],a=e[t+2];n.push(r,i,i,a,a,r)}}else{let e=i.array;o=i.version;for(let t=0,r=e.length/3-1;t<r;t+=3){let e=t+0,r=t+1,i=t+2;n.push(e,r,r,i,i,e)}}let s=new(i.count>=65535?Pp:Np)(n,1);s.version=o;let c=a.get(e);c&&t.remove(c),a.set(e,s)}function u(e){let t=a.get(e);if(t){let n=e.index;n!==null&&t.version<n.version&&l(e)}else l(e);return a.get(e)}return{get:s,update:c,getWireframeAttribute:u}}function zg(e,t,n){let r;function i(e){r=e}let a,o;function s(e){a=e.type,o=e.bytesPerElement}function c(t,i){e.drawElements(r,i,a,t*o),n.update(i,r,1)}function l(t,i,s){s!==0&&(e.drawElementsInstanced(r,i,a,t*o,s),n.update(i,r,s))}function u(e,i,o){if(o===0)return;t.get(`WEBGL_multi_draw`).multiDrawElementsWEBGL(r,i,0,a,e,0,o);let s=0;for(let e=0;e<o;e++)s+=i[e];n.update(s,r,1)}this.setMode=i,this.setIndex=s,this.render=c,this.renderInstances=l,this.renderMultiDraw=u}function Bg(e){let t={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function r(t,r,i){switch(n.calls++,r){case e.TRIANGLES:n.triangles+=t/3*i;break;case e.LINES:n.lines+=t/2*i;break;case e.LINE_STRIP:n.lines+=i*(t-1);break;case e.LINE_LOOP:n.lines+=i*t;break;case e.POINTS:n.points+=i*t;break;default:H(`WebGLInfo: Unknown draw mode:`,r)}}function i(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:t,render:n,programs:null,autoReset:!0,reset:i,update:r}}function Vg(e,t,n){let r=new WeakMap,i=new ff;function a(a,o,s){let c=a.morphTargetInfluences,l=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=l===void 0?0:l.length,d=r.get(o);if(d===void 0||d.count!==u){d!==void 0&&d.texture.dispose();let e=o.morphAttributes.position!==void 0,n=o.morphAttributes.normal!==void 0,a=o.morphAttributes.color!==void 0,s=o.morphAttributes.position||[],c=o.morphAttributes.normal||[],l=o.morphAttributes.color||[],f=0;e===!0&&(f=1),n===!0&&(f=2),a===!0&&(f=3);let p=o.attributes.position.count*f,m=1;p>t.maxTextureSize&&(m=Math.ceil(p/t.maxTextureSize),p=t.maxTextureSize);let h=new Float32Array(p*m*4*u),g=new hf(h,p,m,u);g.type=Zl,g.needsUpdate=!0;let _=f*4;for(let t=0;t<u;t++){let r=s[t],o=c[t],u=l[t],d=p*m*4*t;for(let t=0;t<r.count;t++){let s=t*_;e===!0&&(i.fromBufferAttribute(r,t),h[d+s+0]=i.x,h[d+s+1]=i.y,h[d+s+2]=i.z,h[d+s+3]=0),n===!0&&(i.fromBufferAttribute(o,t),h[d+s+4]=i.x,h[d+s+5]=i.y,h[d+s+6]=i.z,h[d+s+7]=0),a===!0&&(i.fromBufferAttribute(u,t),h[d+s+8]=i.x,h[d+s+9]=i.y,h[d+s+10]=i.z,h[d+s+11]=u.itemSize===4?i.w:1)}}d={count:u,texture:g,size:new W(p,m)},r.set(o,d);function v(){g.dispose(),r.delete(o),o.removeEventListener(`dispose`,v)}o.addEventListener(`dispose`,v)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)s.getUniforms().setValue(e,`morphTexture`,a.morphTexture,n);else{let t=0;for(let e=0;e<c.length;e++)t+=c[e];let n=o.morphTargetsRelative?1:1-t;s.getUniforms().setValue(e,`morphTargetBaseInfluence`,n),s.getUniforms().setValue(e,`morphTargetInfluences`,c)}s.getUniforms().setValue(e,`morphTargetsTexture`,d.texture,n),s.getUniforms().setValue(e,`morphTargetsTextureSize`,d.size)}return{update:a}}function Hg(e,t,n,r,i){let a=new WeakMap;function o(r){let o=i.render.frame,s=r.geometry,l=t.get(r,s);if(a.get(l)!==o&&(t.update(l),a.set(l,o)),r.isInstancedMesh&&(r.hasEventListener(`dispose`,c)===!1&&r.addEventListener(`dispose`,c),a.get(r)!==o&&(n.update(r.instanceMatrix,e.ARRAY_BUFFER),r.instanceColor!==null&&n.update(r.instanceColor,e.ARRAY_BUFFER),a.set(r,o))),r.isSkinnedMesh){let e=r.skeleton;a.get(e)!==o&&(e.update(),a.set(e,o))}return l}function s(){a=new WeakMap}function c(e){let t=e.target;t.removeEventListener(`dispose`,c),r.releaseStatesOfObject(t),n.remove(t.instanceMatrix),t.instanceColor!==null&&n.remove(t.instanceColor)}return{update:o,dispose:s}}var Ug={1:`LINEAR_TONE_MAPPING`,2:`REINHARD_TONE_MAPPING`,3:`CINEON_TONE_MAPPING`,4:`ACES_FILMIC_TONE_MAPPING`,6:`AGX_TONE_MAPPING`,7:`NEUTRAL_TONE_MAPPING`,5:`CUSTOM_TONE_MAPPING`};function Wg(e,t,n,r,i,a){let o=new mf(t,n,{type:e,depthBuffer:i,stencilBuffer:a,samples:r?4:0,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,resolveDepthBuffer:!1,resolveStencilBuffer:!1}),s=null,c=null,l=new qp;l.setAttribute(`position`,new Fp([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute(`uv`,new Fp([0,2,0,0,2,0],2));let u=new oh({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),d=new _m(l,u),f=new Ih(-1,1,1,-1,0,1),p=null,m=null,h=!1,g,_=null,v=[],y=!1;this.setSize=function(e,t){o.setSize(e,t),s!==null&&s.setSize(e,t),c!==null&&c.setSize(e,t);for(let n=0;n<v.length;n++){let r=v[n];r.setSize&&r.setSize(e,t)}},this.setEffects=function(e){v=e,y=v.length>0&&v[0].isRenderPass===!0;let t=o.width,n=o.height;v.length>0&&s===null&&(s=new mf(t,n,{type:Ql,depthBuffer:!1,stencilBuffer:!1}),c=new mf(t,n,{type:Ql,depthBuffer:!1,stencilBuffer:!1}));for(let e=0;e<v.length;e++){let r=v[e];r.setSize&&r.setSize(t,n)}},this.begin=function(e,t){if(h||e.toneMapping===0&&v.length===0)return!1;if(_=t,t!==null){let e=t.width,n=t.height;(o.width!==e||o.height!==n)&&this.setSize(e,n)}return y===!1&&e.setRenderTarget(o),g=e.toneMapping,e.toneMapping=0,!0},this.hasRenderPass=function(){return y},this.end=function(e,t){e.toneMapping=g,h=!0;let n=o,r=s;for(let i=0;i<v.length;i++){let a=v[i];a.enabled!==!1&&(a.render(e,r,n,t),a.needsSwap!==!1&&(n=r,r=r===s?c:s))}if(p!==e.outputColorSpace||m!==e.toneMapping){p=e.outputColorSpace,m=e.toneMapping,u.defines={},q.getTransfer(p)===`srgb`&&(u.defines.SRGB_TRANSFER=``);let t=Ug[m];t&&(u.defines[t]=``),u.needsUpdate=!0}u.uniforms.tDiffuse.value=n.texture,e.setRenderTarget(_),e.render(d,f),_=null,h=!1},this.isCompositing=function(){return h},this.dispose=function(){o.dispose(),s!==null&&s.dispose(),c!==null&&c.dispose(),l.dispose(),u.dispose()}}var Gg=new df,Kg=new Km(1,1),qg=new hf,Jg=new gf,Yg=new Gm,Xg=[],Zg=[],Qg=new Float32Array(16),$g=new Float32Array(9),e_=new Float32Array(4);function t_(e,t,n){let r=e[0];if(r<=0||r>0)return e;let i=t*n,a=Xg[i];if(a===void 0&&(a=new Float32Array(i),Xg[i]=a),t!==0){r.toArray(a,0);for(let r=1,i=0;r!==t;++r)i+=n,e[r].toArray(a,i)}return a}function n_(e,t){if(e.length!==t.length)return!1;for(let n=0,r=e.length;n<r;n++)if(e[n]!==t[n])return!1;return!0}function r_(e,t){for(let n=0,r=t.length;n<r;n++)e[n]=t[n]}function i_(e,t){let n=Zg[t];n===void 0&&(n=new Int32Array(t),Zg[t]=n);for(let r=0;r!==t;++r)n[r]=e.allocateTextureUnit();return n}function a_(e,t){let n=this.cache;n[0]!==t&&(e.uniform1f(this.addr,t),n[0]=t)}function o_(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2f(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(n_(n,t))return;e.uniform2fv(this.addr,t),r_(n,t)}}function s_(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3f(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else if(t.r!==void 0)(n[0]!==t.r||n[1]!==t.g||n[2]!==t.b)&&(e.uniform3f(this.addr,t.r,t.g,t.b),n[0]=t.r,n[1]=t.g,n[2]=t.b);else{if(n_(n,t))return;e.uniform3fv(this.addr,t),r_(n,t)}}function c_(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4f(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(n_(n,t))return;e.uniform4fv(this.addr,t),r_(n,t)}}function l_(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(n_(n,t))return;e.uniformMatrix2fv(this.addr,!1,t),r_(n,t)}else{if(n_(n,r))return;e_.set(r),e.uniformMatrix2fv(this.addr,!1,e_),r_(n,r)}}function u_(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(n_(n,t))return;e.uniformMatrix3fv(this.addr,!1,t),r_(n,t)}else{if(n_(n,r))return;$g.set(r),e.uniformMatrix3fv(this.addr,!1,$g),r_(n,r)}}function d_(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(n_(n,t))return;e.uniformMatrix4fv(this.addr,!1,t),r_(n,t)}else{if(n_(n,r))return;Qg.set(r),e.uniformMatrix4fv(this.addr,!1,Qg),r_(n,r)}}function f_(e,t){let n=this.cache;n[0]!==t&&(e.uniform1i(this.addr,t),n[0]=t)}function p_(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2i(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(n_(n,t))return;e.uniform2iv(this.addr,t),r_(n,t)}}function m_(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3i(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(n_(n,t))return;e.uniform3iv(this.addr,t),r_(n,t)}}function h_(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4i(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(n_(n,t))return;e.uniform4iv(this.addr,t),r_(n,t)}}function g_(e,t){let n=this.cache;n[0]!==t&&(e.uniform1ui(this.addr,t),n[0]=t)}function __(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2ui(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(n_(n,t))return;e.uniform2uiv(this.addr,t),r_(n,t)}}function v_(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3ui(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(n_(n,t))return;e.uniform3uiv(this.addr,t),r_(n,t)}}function y_(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4ui(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(n_(n,t))return;e.uniform4uiv(this.addr,t),r_(n,t)}}function b_(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i);let a;this.type===e.SAMPLER_2D_SHADOW?(Kg.compareFunction=n.isReversedDepthBuffer()?518:515,a=Kg):a=Gg,n.setTexture2D(t||a,i)}function x_(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture3D(t||Jg,i)}function S_(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTextureCube(t||Yg,i)}function C_(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture2DArray(t||qg,i)}function w_(e){switch(e){case 5126:return a_;case 35664:return o_;case 35665:return s_;case 35666:return c_;case 35674:return l_;case 35675:return u_;case 35676:return d_;case 5124:case 35670:return f_;case 35667:case 35671:return p_;case 35668:case 35672:return m_;case 35669:case 35673:return h_;case 5125:return g_;case 36294:return __;case 36295:return v_;case 36296:return y_;case 35678:case 36198:case 36298:case 36306:case 35682:return b_;case 35679:case 36299:case 36307:return x_;case 35680:case 36300:case 36308:case 36293:return S_;case 36289:case 36303:case 36311:case 36292:return C_}}function T_(e,t){e.uniform1fv(this.addr,t)}function E_(e,t){let n=t_(t,this.size,2);e.uniform2fv(this.addr,n)}function D_(e,t){let n=t_(t,this.size,3);e.uniform3fv(this.addr,n)}function O_(e,t){let n=t_(t,this.size,4);e.uniform4fv(this.addr,n)}function k_(e,t){let n=t_(t,this.size,4);e.uniformMatrix2fv(this.addr,!1,n)}function A_(e,t){let n=t_(t,this.size,9);e.uniformMatrix3fv(this.addr,!1,n)}function j_(e,t){let n=t_(t,this.size,16);e.uniformMatrix4fv(this.addr,!1,n)}function M_(e,t){e.uniform1iv(this.addr,t)}function N_(e,t){e.uniform2iv(this.addr,t)}function P_(e,t){e.uniform3iv(this.addr,t)}function F_(e,t){e.uniform4iv(this.addr,t)}function I_(e,t){e.uniform1uiv(this.addr,t)}function L_(e,t){e.uniform2uiv(this.addr,t)}function R_(e,t){e.uniform3uiv(this.addr,t)}function z_(e,t){e.uniform4uiv(this.addr,t)}function B_(e,t,n){let r=this.cache,i=t.length,a=i_(n,i);n_(r,a)||(e.uniform1iv(this.addr,a),r_(r,a));let o;o=this.type===e.SAMPLER_2D_SHADOW?Kg:Gg;for(let e=0;e!==i;++e)n.setTexture2D(t[e]||o,a[e])}function V_(e,t,n){let r=this.cache,i=t.length,a=i_(n,i);n_(r,a)||(e.uniform1iv(this.addr,a),r_(r,a));for(let e=0;e!==i;++e)n.setTexture3D(t[e]||Jg,a[e])}function H_(e,t,n){let r=this.cache,i=t.length,a=i_(n,i);n_(r,a)||(e.uniform1iv(this.addr,a),r_(r,a));for(let e=0;e!==i;++e)n.setTextureCube(t[e]||Yg,a[e])}function U_(e,t,n){let r=this.cache,i=t.length,a=i_(n,i);n_(r,a)||(e.uniform1iv(this.addr,a),r_(r,a));for(let e=0;e!==i;++e)n.setTexture2DArray(t[e]||qg,a[e])}function W_(e){switch(e){case 5126:return T_;case 35664:return E_;case 35665:return D_;case 35666:return O_;case 35674:return k_;case 35675:return A_;case 35676:return j_;case 5124:case 35670:return M_;case 35667:case 35671:return N_;case 35668:case 35672:return P_;case 35669:case 35673:return F_;case 5125:return I_;case 36294:return L_;case 36295:return R_;case 36296:return z_;case 35678:case 36198:case 36298:case 36306:case 35682:return B_;case 35679:case 36299:case 36307:return V_;case 35680:case 36300:case 36308:case 36293:return H_;case 36289:case 36303:case 36311:case 36292:return U_}}var G_=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=w_(t.type)}},K_=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=W_(t.type)}},q_=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let r=this.seq;for(let i=0,a=r.length;i!==a;++i){let a=r[i];a.setValue(e,t[a.id],n)}}},J_=/(\w+)(\])?(\[|\.)?/g;function Y_(e,t){e.seq.push(t),e.map[t.id]=t}function X_(e,t,n){let r=e.name,i=r.length;for(J_.lastIndex=0;;){let a=J_.exec(r),o=J_.lastIndex,s=a[1],c=a[2]===`]`,l=a[3];if(c&&(s|=0),l===void 0||l===`[`&&o+2===i){Y_(n,l===void 0?new G_(s,e,t):new K_(s,e,t));break}{let e=n.map[s];e===void 0&&(e=new q_(s),Y_(n,e)),n=e}}}var Z_=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){let n=e.getActiveUniform(t,r);X_(n,e.getUniformLocation(t,n.name),this)}let r=[],i=[];for(let t of this.seq)t.type===e.SAMPLER_2D_SHADOW||t.type===e.SAMPLER_CUBE_SHADOW||t.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(t):i.push(t);r.length>0&&(this.seq=r.concat(i))}setValue(e,t,n,r){let i=this.map[t];i!==void 0&&i.setValue(e,n,r)}setOptional(e,t,n){let r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let i=0,a=t.length;i!==a;++i){let a=t[i],o=n[a.id];o.needsUpdate!==!1&&a.setValue(e,o.value,r)}}static seqWithValue(e,t){let n=[];for(let r=0,i=e.length;r!==i;++r){let i=e[r];i.id in t&&n.push(i)}return n}};function Q_(e,t,n){let r=e.createShader(t);return e.shaderSource(r,n),e.compileShader(r),r}var $_=37297,ev=0;function tv(e,t){let n=e.split(`
`),r=[],i=Math.max(t-6,0),a=Math.min(t+6,n.length);for(let e=i;e<a;e++){let i=e+1;r.push(`${i===t?`>`:` `} ${i}: ${n[e]}`)}return r.join(`
`)}var nv=new K;function rv(e){q._getMatrix(nv,q.workingColorSpace,e);let t=`mat3( ${nv.elements.map(e=>e.toFixed(4))} )`;switch(q.getTransfer(e)){case od:return[t,`LinearTransferOETF`];case sd:return[t,`sRGBTransferOETF`];default:return V(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function iv(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`

`+i+`

`+tv(e.getShaderSource(t),r)}return i}function av(e,t){let n=rv(t);return[`vec4 ${e}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,`}`].join(`
`)}var ov={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function sv(e,t){let n=ov[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var cv=new G;function lv(){return q.getLuminanceCoefficients(cv),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${cv.x.toFixed(4)}, ${cv.y.toFixed(4)}, ${cv.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
`)}function uv(e){return[e.extensionClipCullDistance?`#extension GL_ANGLE_clip_cull_distance : require`:``,e.extensionMultiDraw?`#extension GL_ANGLE_multi_draw : require`:``].filter(pv).join(`
`)}function dv(e){let t=[];for(let n in e){let r=e[n];r!==!1&&t.push(`#define `+n+` `+r)}return t.join(`
`)}function fv(e,t){let n={},r=e.getProgramParameter(t,e.ACTIVE_ATTRIBUTES);for(let i=0;i<r;i++){let r=e.getActiveAttrib(t,i),a=r.name,o=1;r.type===e.FLOAT_MAT2&&(o=2),r.type===e.FLOAT_MAT3&&(o=3),r.type===e.FLOAT_MAT4&&(o=4),n[a]={type:r.type,location:e.getAttribLocation(t,a),locationSize:o}}return n}function pv(e){return e!==``}function mv(e,t){let n=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return e.replace(/NUM_SUN_LIGHTS/g,t.numSunLights).replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_SUN_LIGHT_SHADOWS/g,t.numSunLightShadows).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function hv(e,t){return e.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var gv=/^[ \t]*#include +<([\w\d./]+)>/gm;function _v(e){return e.replace(gv,yv)}var vv=new Map;function yv(e,t){let n=Y[t];if(n===void 0){let e=vv.get(t);if(e!==void 0)n=Y[e],V(`WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.`,t,e);else throw Error(`THREE.WebGLProgram: Can not resolve #include <`+t+`>`)}return _v(n)}var bv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function xv(e){return e.replace(bv,Sv)}function Sv(e,t,n,r){let i=``;for(let e=parseInt(t);e<parseInt(n);e++)i+=r.replace(/\[\s*i\s*\]/g,`[ `+e+` ]`).replace(/UNROLLED_LOOP_INDEX/g,e);return i}function Cv(e){let t=`precision ${e.precision} float;
...
#define LOW_PRECISION`),t}var wv={1:`SHADOWMAP_TYPE_PCF`,3:`SHADOWMAP_TYPE_VSM`};function Tv(e){return wv[e.shadowMapType]||`SHADOWMAP_TYPE_BASIC`}var Ev={301:`ENVMAP_TYPE_CUBE`,302:`ENVMAP_TYPE_CUBE`,306:`ENVMAP_TYPE_CUBE_UV`};function Dv(e){return e.envMap===!1?`ENVMAP_TYPE_CUBE`:Ev[e.envMapMode]||`ENVMAP_TYPE_CUBE`}var Ov={302:`ENVMAP_MODE_REFRACTION`};function kv(e){return e.envMap===!1?`ENVMAP_MODE_REFLECTION`:Ov[e.envMapMode]||`ENVMAP_MODE_REFLECTION`}var Av={0:`ENVMAP_BLENDING_MULTIPLY`,1:`ENVMAP_BLENDING_MIX`,2:`ENVMAP_BLENDING_ADD`};function jv(e){return e.envMap===!1?`ENVMAP_BLENDING_NONE`:Av[e.combine]||`ENVMAP_BLENDING_NONE`}function Mv(e){let t=e.envMapCubeUVHeight;if(t===null)return null;let n=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(2**n,112)),texelHeight:r,maxMip:n}}function Nv(e,t,n,r){let i=e.getContext(),a=n.defines,o=n.vertexShader,s=n.fragmentShader,c=Tv(n),l=Dv(n),u=kv(n),d=jv(n),f=Mv(n),p=uv(n),m=dv(a),h=i.createProgram(),g,_,v=n.glslVersion?`#version `+n.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},xy=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Sy=new Ih(-1,1,1,-1,0,1),Cy=new class extends qp{constructor(){super(),this.setAttribute(`position`,new Fp([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new Fp([0,2,0,0,2,0],2))}},wy=class{constructor(e){this._mesh=new _m(Cy,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Sy)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Ty=class extends xy{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ah?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=nh.clone(e.uniforms),this.material=new ah({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new wy(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Ey=class extends xy{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Dy=class extends xy{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Oy=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new W);this._width=n.width,this._height=n.height,t=new mf(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Ql}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Ty(by),this.copyPass.material.blending=0,this.timer=new Vh}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Ey!==void 0&&(r instanceof Ey?n=!0:r instanceof Dy&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new W);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},ky=class extends xy{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new J}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Ay={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new J(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},jy=class e extends xy{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new W(256,256):new W(e.x,e.y),this.clearColor=new J(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new mf(i,a,{type:Ql,depthBuffer:!1}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new mf(i,a,{type:Ql,depthBuffer:!1});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new mf(i,a,{type:Ql,depthBuffer:!1});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=Ay;this.highPassUniforms=nh.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new ah({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new W(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new G(1,1,1),new G(1,1,1),new G(1,1,1),new G(1,1,1),new G(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=nh.clone(by.uniforms),this.blendMaterial=new ah({uniforms:this.copyUniforms,vertexShader:by.vertexShader,fragmentShader:by.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new J,this._oldClearAlpha=1,this._basic=new am,this._fsQuad=new wy(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new W(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);let r=[],i=[];for(let n=1;n<e;n+=2){let a=t[n],o=n+1<e?t[n+1]:0,s=a+o;r.push((n*a+(n+1)*o)/s),i.push(s)}return new ah({defines:{KERNEL_PAIRS:r.length},uniforms:{colorTexture:{value:null},invSize:{value:new W(.5,.5)},direction:{value:new W(.5,.5)},centerWeight:{value:t[0]},gaussianOffsets:{value:r},gaussianWeights:{value:i}},vertexShader:`
				...
				}`})}_getCompositeMaterial(e){return new ah({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`
				...
				}`})}};jy.BlurDirectionX=new W(1,0),jy.BlurDirectionY=new W(0,1);var My={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
    ...
    }`},Fy=new J(`#032b3d`),Iy=new J(`#37e1ff`),Ly=new J(`#e8fdff`),Ry=new J(`#ff3d5e`),zy=.52,By=2,Vy=e=>e.toFixed(3),Hy=`
...
vec2 rot(vec2 v, float a){ float c = cos(a), s = sin(a); return vec2(c * v.x - s * v.y, s * v.x + c * v.y); }`,Uy=`varying vec2 vP; void main(){ vP = position.xy; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,Wy={transparent:!0,depthWrite:!1,depthTest:!1,blending:2},Gy=class{canvas;getInput;renderer;scene=new $f;camera=new Fh(38,1,.1,200);composer;bloom;post;timer=new Vh;raf=0;sizeW=0;sizeH=0;observer=null;eye=new Gf;overlay=new $f;overlayEye=new Gf;uniforms={uTime:{value:0},uLevel:{value:0},uEnergy:{value:0},uPupil:{value:zy},uLook:{value:new W},uDeep:{value:Fy.clone()},uCyan:{value:Iy.clone()},uIce:{value:Ly.clone()},uIntensity:{value:1},uPulse:{value:0},uPulseAmp:{value:0}};state=`offline`;damage=.15;energy=0;voice=0;mic=0;tilt=new W;tiltVel=new W;look=new W;lookTarget=new W;nextSaccade=0;distance=10;baseDistance=10;zoom=1;lookY=0;pulsePhase=1;constructor(e,t,n={}){this.canvas=e,this.getInput=t,this.renderer=new yy({canvas:e,antialias:!0,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,n.maxPixelRatio??2)),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.05,this.scene.background=new J(`#000204`),this.scene.add(this.eye),this.overlay.add(this.overlayEye),this.buildDust(),this.buildHud(),this.buildIris(),this.buildStreaks(),this.buildPupil(),this.buildCornea(),this.composer=new Oy(this.renderer),this.composer.addPass(new ky(this.scene,this.camera)),this.bloom=new jy(new W(1,1),.55,.5,.55),this.composer.addPass(this.bloom);let r=new ky(this.overlay,this.camera);r.clear=!1,this.composer.addPass(r),this.post=new Ty(Py),this.post.uniforms.uScan.value=.2,this.post.uniforms.uGrain.value=.012,this.composer.addPass(this.post),this.composer.addPass(new Ny),typeof ResizeObserver<`u`&&(this.observer=new ResizeObserver(()=>this.resize()),this.observer.observe(e)),this.resize(),this.loop()}buildIris(){let e=new ah({...Wy,uniforms:this.uniforms,vertexShader:Uy,fragmentShader:`
        ${Hy}
        ...
        void main(){
          ...
          float t = clamp((r - uPupil) / (${Vy(By)} - uPupil), 0.0, 1.0);
          ...
          float edge = 1.0 - smoothstep(${Vy(1.92)}, ${Vy(2.04)}, r);
          ...
          float halo = exp(-max(r - ${Vy(By)}, 0.0) * 6.0) * 0.12 * (1.0 - edge);
        ...
        }`}),t=new _m(new Xm(5,5),e);t.renderOrder=2,this.eye.add(t)}buildStreaks(){let e=1800,t=new Float32Array(e),n=new Float32Array(e),r=new Float32Array(e),i=new Float32Array(e),a=new Float32Array(e);for(let e=0;e<900;e++){let o=Math.random()*Math.PI*2,s=.56+Math.random()**1.6*1.48*.8,c=.1+Math.random()**2.5*1.6,l=Math.random();for(let u=0;u<2;u++){let d=e*2+u;t[d]=o,n[d]=s,r[d]=c,i[d]=u,a[d]=l}}let o=new qp;o.setAttribute(`position`,new Mp(new Float32Array(e*3),3)),o.setAttribute(`aAngle`,new Mp(t,1)),o.setAttribute(`aR0`,new Mp(n,1)),o.setAttribute(`aLen`,new Mp(r,1)),o.setAttribute(`aT`,new Mp(i,1)),o.setAttribute(`aSeed`,new Mp(a,1)),o.boundingSphere=new zp(new G,10);let s=new Lm(o,new ah({...Wy,uniforms:this.uniforms,vertexShader:`
        ...
        }`}));s.renderOrder=3,this.eye.add(s)}buildHud(){let e=new ah({...Wy,uniforms:this.uniforms,vertexShader:Uy,fragmentShader:`
        ${Hy}
        ...
        void main(){
          ...
          // 7. Speech shockwave.
          float pr = ${Vy(By)} + uPulse * 3.2;
          w += line(r - pr, 0.006 + uPulse * 0.01) * (1.0 - uPulse) * uPulseAmp;

          float fade = 1.0 - smoothstep(${Vy(3.2)}, ${Vy(4.4)}, r);
          vec3 col = uCyan * v * (0.6 + uEnergy * 0.5) * (0.35 + fade * 0.65) + uIce * w;
          gl_FragColor = vec4(col * uIntensity, 1.0);
        }`}),t=new _m(new Xm(11,11),e);t.renderOrder=1,this.eye.add(t)}buildPupil(){let e=new ah({transparent:!0,depthWrite:!1,depthTest:!1,uniforms:this.uniforms,vertexShader:Uy,fragmentShader:`
        ...
        }`}),t=new _m(new Xm(2,2),e);t.renderOrder=5,this.overlayEye.add(t)}buildCornea(){let e=new ah({...Wy,uniforms:this.uniforms,vertexShader:Uy,fragmentShader:`
        ...
        void main(){
          ...
          float r = length(p);
          float arc = exp(-abs(r - ${Vy(By*.93)}) * 60.0) * smoothstep(0.1, 0.7, p.y / max(r, 1e-3)) * 0.05;
          gl_FragColor = vec4(uIce * (spot + dotL + arc) * uIntensity, 1.0);
        }`}),t=new _m(new Xm(5,5),e);t.renderOrder=6,this.overlayEye.add(t)}buildDust(){let e=1400,t=new Float32Array(e*3);for(let n=0;n<e;n++){let e=Math.random()*Math.PI*2,r=3.8+Math.random()**.8*10;t.set([Math.cos(e)*r,Math.sin(e)*r,-1-Math.random()*8],n*3)}let n=new qp;n.setAttribute(`position`,new Mp(t,3));let r=new Um(n,new Rm({...Wy,color:Iy.clone().multiplyScalar(.6),size:.03,opacity:.35}));r.name=`dust`,r.renderOrder=0,this.scene.add(r)}setState(e){e===`speaking`&&this.state!==`speaking`&&(this.pulsePhase=0),this.state=e}setDamage(e){this.damage=e}resize(){let e=this.canvas.clientWidth||window.innerWidth,t=this.canvas.clientHeight||window.innerHeight;if(!e||!t)return;this.sizeW=e,this.sizeH=t,this.renderer.setSize(e,t,!1),this.composer.setSize(e,t),this.post.uniforms.uResolution.value.set(e,t),this.camera.aspect=e/t,this.camera.updateProjectionMatrix();let n=qd.degToRad(this.camera.fov/2),r=3.5/(Math.tan(n)*this.camera.aspect),i=4.2/Math.tan(n);this.baseDistance=Math.max(r,i*.75),this.lookY=e<t?-this.baseDistance*Math.tan(n)*.3:0}dispose(){cancelAnimationFrame(this.raf),this.observer?.disconnect(),this.composer.dispose(),this.renderer.dispose()}loop=()=>{this.raf=requestAnimationFrame(this.loop),(this.canvas.clientWidth!==this.sizeW||this.canvas.clientHeight!==this.sizeH)&&this.resize(),this.timer.update();let e=Math.min(this.timer.getDelta(),.05),t=this.timer.getElapsed(),n=this.getInput();this.voice+=(n.voice-this.voice)*.3,this.mic+=(n.mic-this.mic)*.3;let r={offline:.3,connecting:.5,listening:.6,thinking:.9,speaking:.8,acting:1};this.energy+=(r[this.state]-this.energy)*e*2.5;let i=this.voice+this.mic*.4,a=zy*(this.state===`listening`?.8:this.state===`thinking`?.9:this.state===`offline`?1.05:1)+Math.sin(t*1.1)*.012+this.voice*.1;if(this.uniforms.uPupil.value+=(a-this.uniforms.uPupil.value)*.12,n.look)this.lookTarget.set(n.look.x,n.look.y).clampLength(0,1),this.nextSaccade=t+1.5;else if(t>this.nextSaccade){let e=this.state===`thinking`?.6:.3;this.lookTarget.set((Math.random()-.5)*e,(Math.random()-.5)*e*.7),this.nextSaccade=t+.8+Math.random()*(this.state===`thinking`?.9:2.8)}this.look.lerp(this.lookTarget,n.look?.18:.22),this.uniforms.uLook.value.copy(this.look),this.tiltVel.x+=n.spin.x*.5,this.tiltVel.y+=n.spin.y*.5,this.tiltVel.multiplyScalar(.88),this.tilt.add(this.tiltVel).multiplyScalar(.95),this.tilt.clampScalar(-.5,.5),this.eye.rotation.set(this.tilt.x-this.look.y*.05,this.tilt.y+this.look.x*.05,0),this.overlayEye.rotation.copy(this.eye.rotation);let o=Iy.clone().lerp(Ly,this.state===`acting`?.3:0).lerp(Ry,Math.max(0,this.damage-.6)*1.2);this.uniforms.uCyan.value.copy(o),this.uniforms.uTime.value=t,this.uniforms.uLevel.value=i,this.uniforms.uEnergy.value=this.energy,this.uniforms.uIntensity.value=this.state===`offline`?.85:1,this.state===`speaking`&&this.voice>.45&&this.pulsePhase>.6&&(this.pulsePhase=0),this.pulsePhase=Math.min(1,this.pulsePhase+e*.7),this.uniforms.uPulse.value=this.pulsePhase,this.uniforms.uPulseAmp.value=.25+this.voice*.4;let s=this.scene.getObjectByName(`dust`);s&&(s.rotation.z+=e*(.006+this.energy*.012)),this.zoom=qd.clamp(this.zoom/n.zoom,.5,1.8);let c=this.baseDistance*this.zoom;this.distance+=(c-this.distance)*.1,this.camera.position.set(Math.sin(t*.17)*.08,this.lookY+Math.sin(t*.13)*.06,this.distance),this.camera.lookAt(0,this.lookY,0);let l=this.damage*.06+(this.voice>.6?this.damage*.15:0);this.post.uniforms.uTime.value=t,this.post.uniforms.uGlitch.value=Math.random()<l?.3+Math.random()*.5:this.damage*.06,this.post.uniforms.uAberration.value=8e-4+i*.0025,this.bloom.strength=.5+i*.3+this.energy*.12,this.composer.render(e)}};function Ky(e){let t=2048,n=new Float32Array(t);for(let r=0;r<t;r++){let t=r/2047*2-1;n[r]=e<.05?t:Math.tanh(t*e)/Math.tanh(e)}return n}function qy(e,t=1.1,n=3.2){let r=Math.floor(e.sampleRate*t),i=e.createBuffer(2,r,e.sampleRate);for(let e=0;e<2;e++){let t=i.getChannelData(e);for(let e=0;e<r;e++)t[e]=(Math.random()*2-1)*(1-e/r)**n}return i}var Jy={cinematic:{rate:.9,pitch:1,ringMix:0,comb:0,doubler:0,reverb:.1,drive:0,lowShelf:4,presence:1.5},robot:{rate:.95,pitch:.82,ringMix:.25,comb:.28,doubler:.2,reverb:.06,drive:1.6,lowShelf:5,presence:3.5},natural:{rate:1,pitch:1,ringMix:0,comb:0,doubler:0,reverb:0,drive:0,lowShelf:0,presence:0}};async function Yy(e=`/worklets/ultron-voice.js`,t=new AudioContext,n=`cinematic`){await t.audioWorklet.addModule(e);let r=new AudioWorkletNode(t,`ultron-voice`,{outputChannelCount:[1]}),i=t.createGain(),a=t.createGain();r.connect(a).connect(i);let o=t.createGain();for(let[e,n]of[[11,.23],[17,.31]]){let i=t.createDelay(.05);i.delayTime.value=e/1e3;let a=t.createOscillator();a.frequency.value=n;let s=t.createGain();s.gain.value=.0015,a.connect(s).connect(i.delayTime),a.start(),r.connect(i).connect(o)}o.connect(i);let s=t.createGain();for(let e of[3.7,5.9,8.3]){let n=t.createDelay(.05);n.delayTime.value=e/1e3;let i=t.createGain();i.gain.value=.5,r.connect(n),n.connect(i).connect(n),n.connect(s)}s.connect(i);let c=t.createWaveShaper();c.oversample=`4x`;let l=t.createBiquadFilter();l.type=`highpass`,l.frequency.value=70;let u=t.createBiquadFilter();u.type=`lowshelf`,u.frequency.value=160;let d=t.createBiquadFilter();d.type=`peaking`,d.frequency.value=3e3,d.Q.value=.9;let f=t.createDynamicsCompressor();f.threshold.value=-20,f.knee.value=12,f.ratio.value=3,f.attack.value=.005,f.release.value=.2;let p=t.createConvolver();p.buffer=qy(t);let m=t.createGain(),h=t.createGain();h.gain.value=.8;let g=t.createDynamicsCompressor();g.threshold.value=-3,g.knee.value=0,g.ratio.value=20,g.attack.value=.001,g.release.value=.1;let _=t.createAnalyser();_.fftSize=512,_.smoothingTimeConstant=.6,i.connect(c).connect(l).connect(u).connect(d).connect(f),f.connect(h),f.connect(p).connect(m).connect(h),h.connect(g),g.connect(_),g.connect(t.destination);let v=t.createGain(),y=t.createDynamicsCompressor();y.knee.value=8,y.ratio.value=6,y.attack.value=.002,y.release.value=.25;let b=t.createGain(),x=t.createDynamicsCompressor();x.threshold.value=-4,x.knee.value=0,x.ratio.value=20,x.attack.value=.001,x.release.value=.15;let S=t.createGain();S.gain.value=.9,v.connect(y).connect(b).connect(x).connect(S),S.connect(_),S.connect(t.destination);let C=e=>{y.threshold.value=e?-30:-3,b.gain.value=e?3.2:1};C(!1);let w=null,T=new Audio;T.muted=!0;let E=e=>r.parameters.get(e),D=n,O=0,k=()=>{let e=Jy[D],n=t.currentTime,r=O;E(`pitch`).setTargetAtTime(e.pitch,n,.02),E(`ringMix`).setTargetAtTime(Math.min(1,e.ringMix+r*.25),n,.05),E(`damage`).setTargetAtTime(r,n,.05),a.gain.setTargetAtTime(D===`robot`?.8:1,n,.02),o.gain.setTargetAtTime(e.doubler,n,.05),s.gain.setTargetAtTime(e.comb+(D===`natural`?0:r*.25),n,.05),m.gain.setTargetAtTime(e.reverb,n,.05),u.gain.setTargetAtTime(e.lowShelf,n,.05),d.gain.setTargetAtTime(e.presence,n,.05),c.curve=Ky(e.drive+(D===`natural`?0:r*6))};return k(),{ctx:t,input:r,direct:v,setLoud:C,analyser:_,get rate(){return Jy[D].rate},setDamage(e){O=Math.max(0,Math.min(1,e)),k()},setStyle(e){D=e,k()},connectStream(e){w?.disconnect(),T.srcObject=e,T.play().catch(()=>{}),w=t.createMediaStreamSource(e),w.connect(r)},close(){w?.disconnect(),T.srcObject=null,t.close().catch(()=>{})}}}function Xy(e,t){let n=.008,r=0;for(;r<e.length&&Math.abs(e[r])<n;)r++;let i=e.length-1;for(;i>r&&Math.abs(e[i])<n;)i--;if(r>=i)return[0,e.length];let a=Math.round(t*.04);return[Math.max(0,r-a),Math.min(e.length,i+a*3)]}function Zy(e,t,n){let r=t.sampleRate,i=Array.from({length:t.numberOfChannels},(e,n)=>t.getChannelData(n)),[a,o]=Xy(i[0],r),s=o-a,c=i.map(e=>e.subarray(a,o)),l=c[0];if(Math.abs(n-1)<.01||s<r*.1){let t=e.createBuffer(c.length,s,r);return c.forEach((e,n)=>t.copyToChannel(e,n)),t}let u=Math.round(r*.03)&-2,d=u/2,f=d*n,p=Math.round(r*.008),m=Math.floor(s/n),h=e.createBuffer(c.length,m,r),g=Array.from({length:c.length},(e,t)=>h.getChannelData(t)),_=new Float32Array(u);for(let e=0;e<u;e++)_[e]=.5-.5*Math.cos(2*Math.PI*e/u);let v=0;for(let e=0;e*d<m;e++){let t=e*d,n=Math.round(e*f),r=Math.min(n,Math.max(0,s-u));if(e>0){let e=v+d;if(e+u<=s){let t=(t,n)=>{let r=0,i=1e-9;for(let a=0;a<u;a+=n){let n=l[t+a];r+=l[e+a]*n,i+=n*n}return r/Math.sqrt(i)},i=Math.max(0,n-p),a=Math.min(s-u,n+p),o=-1/0;for(let e=i;e<=a;e+=3){let n=t(e,3);n>o&&(o=n,r=e)}let c=r;o=-1/0;for(let e=Math.max(i,c-3);e<=Math.min(a,c+3);e++){let n=t(e,1);n>o&&(o=n,r=e)}}}for(let e=0;e<c.length;e++){let n=c[e],i=g[e];for(let e=0;e<u&&t+e<m&&r+e<s;e++)i[t+e]+=n[r+e]*_[e]}v=r}return h}var Qy=typeof window<`u`?window.SpeechRecognition??window.webkitSpeechRecognition:void 0,$y=!!Qy,eb=typeof navigator<`u`?navigator.audioSession:void 0,tb=!1;function nb(e){try{eb&&(eb.type=e)}catch{}}var rb=typeof speechSynthesis<`u`,ib=class{rec=null;level=0;get listening(){return!!this.rec}start(e,t){if(!Qy)return t.onError(`Speech recognition isn't available in this browser. Use Safari, or type.`);this.stop();let n=new Qy;n.lang=e,n.continuous=!1,n.interimResults=!0;let r=``;n.onresult=e=>{let n=``;for(let t=e.resultIndex;t<e.results.length;t++){let i=e.results[t];i.isFinal?r+=i[0].transcript:n+=i[0].transcript}this.level=.6+Math.random()*.4,t.onInterim((r+n).trim())},n.onerror=e=>{e.error!==`no-speech`&&e.error!==`aborted`&&t.onError(e.error===`not-allowed`||e.error===`service-not-allowed`?`Mic or Speech Recognition is blocked. Allow it in Settings › Safari (and Siri & Dictation must be on).`:`Speech error: ${e.error}`)},n.onend=()=>{if(this.rec!==n)return;this.rec=null;let e=r.trim();e&&t.onFinal(e),t.onEnd()},this.rec=n,tb=!0,n.start()}stop(){this.rec?.stop()}cancel(){let e=this.rec;this.rec=null,e?.abort()}},ab=class e{workletUrl;voiceURI=``;lang=`en-US`;damage=.15;level=0;eleven=null;style=`natural`;speed=1.18;depth=.3;onIdle=null;onStart=null;loud=!1;fast=!1;onError=null;buffer=``;pending=``;startedReply=!1;takes=0;lastSpoken=``;queued=0;boost=0;fx=null;fxLoading=null;chain=Promise.resolve();generation=0;abort=new AbortController;current=null;levelBuf=new Uint8Array(512);lastError=``;constructor(e){this.workletUrl=e;let t=()=>{if(this.fx&&this.current){this.fx.analyser.getByteTimeDomainData(this.levelBuf);let e=0;for(let t=0;t<this.levelBuf.length;t++){let n=(this.levelBuf[t]-128)/128;e+=n*n}this.level=Math.min(1,Math.sqrt(e/this.levelBuf.length)*4)}else rb&&speechSynthesis.speaking?(this.boost*=.85,this.level=.35+Math.random()*.35+this.boost):this.level*=.8;requestAnimationFrame(t)};requestAnimationFrame(t)}static voices(){return rb?speechSynthesis.getVoices():[]}static bestVoice(t){let n=t.split(`-`)[0].toLowerCase(),r=e.voices().filter(e=>e.lang.toLowerCase().startsWith(n)),i=[`evan`,`nathan`,`aaron`,`tom`,`reed`,`daniel`,`arthur`,`fred`,`alex`],a=e=>{let n=`${e.name} ${e.voiceURI}`.toLowerCase(),r=0;return n.includes(`premium`)&&(r+=4),n.includes(`enhanced`)&&(r+=3),n.includes(`siri`)&&(r+=2),i.some(e=>n.includes(e))&&(r+=2),e.lang.toLowerCase()===t.toLowerCase()&&(r+=1),r};return r.sort((e,t)=>a(t)-a(e))[0]}unlock(){if(nb(`playback`),rb){let e=new SpeechSynthesisUtterance(` `);e.volume=0,speechSynthesis.speak(e)}if(!this.fxLoading){let e=new AudioContext;this.fxLoading=Yy(this.workletUrl,e,this.style).then(e=>(e.setDamage(this.damage),this.fx=e,e)).catch(e=>(this.onError?.(`Voice FX failed to load: ${e.message}`),null))}this.fx?.ctx.resume().catch(()=>{})}setStyle(e){this.style=e,this.fx?.setStyle(e)}setDamage(e){this.damage=e,this.fx?.setDamage(e)}feed(e){this.buffer+=e;let t=/[^.!?。！？\n]+[.!?。！？]+["')\]]*\s+|[^\n]*\n+/g,n,r=0;for(;n=t.exec(this.buffer);)r=t.lastIndex,this.pending+=n[0],this.pending.length>=([20,100][this.takes]??300)&&(this.takes++,this.startedReply=!0,this.say(this.pending),this.pending=``);this.buffer=this.buffer.slice(r)}flush(){let e=this.pending+this.buffer;e.trim()&&this.say(e),this.pending=``,this.buffer=``,this.startedReply=!1,this.takes=0,this.lastSpoken=``,this.queued===0&&this.onIdle?.()}stop(){this.buffer=``,this.pending=``,this.startedReply=!1,this.takes=0,this.lastSpoken=``,this.queued=0,this.generation++,this.abort.abort(),this.abort=new AbortController,this.chain=Promise.resolve();try{this.current?.stop()}catch{}this.current=null,this.fx?.setDamage(this.damage),rb&&speechSynthesis.cancel()}get speaking(){return this.queued>0}done(e){e===this.generation&&(this.queued=Math.max(0,this.queued-1),this.queued===0&&!this.buffer&&this.onIdle?.())}say(e){let t=e.replace(/[*_#`>]/g,``).replace(/https?:\/\/\S+/g,`link`).trim();if(!t)return;this.queued++;let n=this.generation;if(this.eleven?.apiKey&&this.eleven.voiceId){let e=fc(this.eleven.apiKey,this.eleven.voiceId,t,this.abort.signal,this.lastSpoken,this.speed,this.fast);this.lastSpoken=(this.lastSpoken+` `+t).slice(-500),e.catch(()=>{}),this.chain=this.chain.then(()=>this.playEleven(t,e,n))}else this.chain=this.chain.then(()=>this.speakSystem(t,n))}async prepareOutput(e){tb&&(tb=!1,nb(`ambient`),nb(`playback`),await new Promise(e=>setTimeout(e,40))),e&&e.state!==`running`&&await e.resume().catch(()=>{}),this.fx?.setLoud(this.loud)}async playEleven(e,t,n){if(n===this.generation)try{let[{bytes:e,applied:r},i]=await Promise.all([t,this.fxLoading??Promise.resolve(null)]);if(n!==this.generation)return;if(!i)throw Error(`audio engine not ready`);let a=Zy(i.ctx,await i.ctx.decodeAudioData(e),this.speed/r);if(n!==this.generation)return;let o=this.damage>=.35&&Math.random()<this.damage*.3;if(i.setDamage(o?Math.min(1,this.damage+.2+Math.random()*.2):this.damage),await this.prepareOutput(i.ctx),n!==this.generation)return;let s=i.ctx.createBufferSource();s.buffer=a,s.playbackRate.value=this.style===`natural`?1:1-this.depth*.15,s.connect(this.style===`natural`&&!o?i.direct:i.input),this.current=s,await new Promise(e=>{s.onended=()=>e(),s.start(),this.onStart?.()}),this.current===s&&(this.current=null),i.setDamage(this.damage),this.done(n)}catch(t){if(n!==this.generation)return;let r=t.message;r!==this.lastError&&(this.lastError=r,this.onError?.(`${r} Using the built-in voice.`)),await this.speakSystem(e,n)}}speakSystem(t,n){return n===this.generation?rb?this.prepareOutput().then(()=>new Promise(r=>{if(n!==this.generation)return r();let i=new SpeechSynthesisUtterance(t),a=speechSynthesis.getVoices().find(e=>e.voiceURI===this.voiceURI)??e.bestVoice(this.lang);a&&(i.voice=a),i.lang=a?.lang||this.lang,i.pitch=Math.max(.6,1-this.depth*.3-this.damage*.2),i.rate=Math.min(1.3,.95*this.speed-this.damage*.08),i.onboundary=()=>this.boost=.35,i.onstart=()=>this.onStart?.();let o=()=>{this.done(n),r()};i.onend=o,i.onerror=o,speechSynthesis.speak(i)})):(this.done(n),Promise.resolve()):Promise.resolve()}},Z=e=>document.getElementById(e),ob=e=>e?`…${e.slice(-4)}`:`none`,Q=wc(),sb=new ib,$=new ab(t);$.voiceURI=Q.voiceURI,$.lang=Q.speechLang,$.damage=Q.damage,$.style=Q.voiceStyle,$.speed=Q.voiceSpeed,$.depth=Q.voiceDepth,$.fast=Q.voiceFast;function cb(){let e=Q.elevenCustomVoiceId||Q.elevenVoiceId;$.eleven=Q.elevenKey&&e?{apiKey:Q.elevenKey,voiceId:e}:null}cb();var lb=`offline`,ub=!1,db=0,fb=null,pb={x:0,y:0},mb=1,hb=null,gb=new Gy(Z(`orb`),()=>{let e={...pb},t=mb,n=hb;if(pb.x=pb.y=0,mb=1,fb){let r=fb.read(performance.now());e.x+=r.spinDelta.x,e.y+=r.spinDelta.y,t*=r.zoomDelta,r.cursor&&(n={x:r.cursor.x*2-1,y:-(r.cursor.y*2-1)}),Vb(r.landmarks,r.pinching)}return sb.level*=.9,{voice:$.level,mic:sb.listening?.2+sb.level*.6:0,spin:e,zoom:t,look:n}},{maxPixelRatio:2});gb.setDamage(Q.damage),addEventListener(`resize`,()=>gb.resize());{let e=Z(`orb`),t=new Map,n=0,r=()=>{let[e,n]=[...t.values()];return Math.hypot(e.x-n.x,e.y-n.y)},i=t=>{let n=e.getBoundingClientRect();hb={x:(t.clientX-n.left)/n.width*2-1,y:-((t.clientY-n.top)/n.height*2-1)}};e.addEventListener(`pointerdown`,a=>{e.setPointerCapture(a.pointerId),t.set(a.pointerId,{x:a.clientX,y:a.clientY}),t.size===2&&(n=r()),i(a)}),e.addEventListener(`pointermove`,e=>{let a=t.get(e.pointerId);if(a&&(t.size===1&&(pb.x+=(e.clientY-a.y)/innerHeight*1.5,pb.y+=(e.clientX-a.x)/innerWidth*1.5,i(e)),t.set(e.pointerId,{x:e.clientX,y:e.clientY}),t.size===2)){let e=r();n&&(mb*=e/n),n=e}});let a=e=>{t.delete(e.pointerId),n=0,t.size||(hb=null)};e.addEventListener(`pointerup`,a),e.addEventListener(`pointercancel`,a),e.addEventListener(`wheel`,e=>mb*=e.deltaY>0?.95:1.05,{passive:!0})}var _b={offline:`STANDBY`,connecting:`CONNECTING`,listening:`LISTENING`,thinking:`THINKING`,speaking:`SPEAKING`,acting:`EXECUTING`};function vb(e){lb=e,gb.setState(e),Z(`status`).className=`status s-${e}`,Z(`status-text`).textContent=_b[e],Z(`mic`).classList.toggle(`live`,e===`listening`&&!Pb),Z(`call-mute`).classList.toggle(`live`,e===`listening`&&Pb)}function yb(e,t=``){let n=Z(`log`),r=document.createElement(`div`);r.className=`line r-${e}`;let i=document.createElement(`div`);for(i.className=`bubble`,i.textContent=t,r.appendChild(i),n.appendChild(r);n.children.length>60;)n.firstChild.remove();return n.scrollTop=n.scrollHeight,i}function bb(e){Z(`caption`).textContent=e}function xb(e){let t=Z(`actions`),n=document.createElement(`a`);for(n.className=`action`,n.href=e.url,n.textContent=`▶ ${e.label}`,n.addEventListener(`click`,()=>setTimeout(()=>n.remove(),400)),t.appendChild(n);t.children.length>3;)t.firstChild.remove()}function Sb(e){Q.damage=e,$.setDamage(e),gb.setDamage(e),Dc(Q)}function Cb(e){db+=e,Z(`cost`).textContent=mc(Q.model)!==`claude`&&db===0?`FREE · ${mc(Q.model)===`groq`?`Groq`:`Gemini`}`:`≈ $${db.toFixed(db<.1?4:2)} this session`}var wb={showAction:xb,setDamage:e=>{Sb(e),Kb()}},Tb={claude:new Zc(()=>({apiKey:Q.apiKey,model:Q.model,webSearch:Q.webSearch}),wb),gemini:new Cl(()=>({apiKey:Q.geminiKey,model:Q.model,webSearch:Q.webSearch,groqKey:Q.groqKey}),wb),groq:new Fl({name:`Groq`,base:`https://api.groq.com/openai/v1`,historyKey:`ultron.groq.history.v1`,maxHistory:14,fallbacks:[`openai/gpt-oss-120b`,`openai/gpt-oss-20b`,`llama-3.3-70b-versatile`],labelOf:e=>e in pc?pc[e].label.split(` · `)[0]:e},()=>({apiKey:Q.groqKey,model:Q.model,webSearch:Q.webSearch,groqKey:Q.groqKey}),wb)},Eb={ask:(...e)=>Tb[mc(Q.model)].ask(...e),stop:()=>Object.values(Tb).forEach(e=>e.stop()),reset:()=>Object.values(Tb).forEach(e=>e.reset())},Db=()=>Tc(Q,mc(Q.model));$.onError=e=>yb(`sys`,e),$.onStart=()=>{lb!==`listening`&&vb(`speaking`)},$.onIdle=()=>{ub||(vb(`offline`),Pb&&!Fb&&Ab())};async function Ob(e){if(!e.trim()||ub)return;Z(`actions`).replaceChildren(),yb(`you`,e),Pb&&bb(``),ub=!0,vb(`thinking`);let t=null,n=``,r=!1,i;try{i=await Eb.ask(e,{onText(e){r=!0,t??=yb(`ultron`),n+=e,t.textContent=n,Pb&&bb(n),Z(`log`).scrollTop=Z(`log`).scrollHeight,$.feed(e)},onTool(e){r=!0,vb(`acting`),yb(`tool`,`⚙ ${e.replace(/_/g,` `)}`),$.flush(),t=null,n=``},onUsage:Cb,onNotice:e=>yb(`sys`,e)})}catch(e){i=`⚠ ${e?.message||String(e)}`}if(ub=!1,!i&&!r&&(i=`⚠ Got an empty reply from Claude.`),i){yb(`sys`,i),Pb&&bb(i),$.stop(),vb(`offline`),Pb&&!Fb&&setTimeout(Ab,800);return}$.flush()}function kb(){Eb.stop(),$.stop(),ub=!1,vb(`offline`)}function Ab(){if(!$y){yb(`sys`,`Voice input isn't supported here. Type instead (or use the keyboard's mic).`),Pb&&zb();return}let e=null;vb(`listening`),sb.start(Q.speechLang,{onInterim(t){if(Pb)return bb(t);e??=yb(`you`),e.textContent=t},onFinal(t){e?.parentElement?.remove(),$.loud=!0,Ob(t)},onError(e){yb(`sys`,e),Pb&&zb()},onEnd(){lb===`listening`&&(vb(`offline`),Pb&&!Fb&&!ub&&setTimeout(()=>Pb&&!ub&&!sb.listening&&Ab(),250))}})}function jb(){return!Db()&&(Z(`welcome`).showModal(),!0)}var Mb=Z(`type-input`),Nb=()=>Z(`composer`).classList.toggle(`has-text`,!!Mb.value.trim());Mb.addEventListener(`input`,Nb),Z(`composer`).addEventListener(`submit`,e=>{if(e.preventDefault(),$.unlock(),jb())return;let t=Mb.value;Mb.value=``,Nb(),(ub||$.speaking)&&kb(),$.loud=Pb,Ob(t)}),Z(`mic`).addEventListener(`click`,()=>{if($.unlock(),!jb()){if(sb.listening)return sb.stop();if(ub||$.speaking)return kb();Ab()}});var Pb=!1,Fb=!1,Ib=0,Lb=0;function Rb(){if($.unlock(),jb())return;if(!$y)return yb(`sys`,`Voice calls need Safari's speech recognition (Settings › Siri & Dictation on).`);Pb=!0,Fb=!1,document.body.classList.add(`in-call`),Z(`callbar`).classList.remove(`hidden`),Z(`call-mute`).classList.remove(`muted`),bb($.eleven?`Connected.`:`Connected. (Add an ElevenLabs key in settings for the real Ultron voice.)`),Ib=Date.now();let e=()=>{let e=Math.floor((Date.now()-Ib)/1e3);Z(`call-timer`).textContent=`${String(Math.floor(e/60)).padStart(2,`0`)}:${String(e%60).padStart(2,`0`)}`};e(),Lb=window.setInterval(e,1e3),(ub||$.speaking)&&kb(),Ab()}function zb(){Pb=!1,document.body.classList.remove(`in-call`),Z(`callbar`).classList.add(`hidden`),clearInterval(Lb),sb.cancel(),(ub||$.speaking)&&kb(),vb(`offline`);let e=Math.floor((Date.now()-Ib)/1e3);yb(`sys`,`Call ended · ${Math.floor(e/60)}:${String(e%60).padStart(2,`0`)}`)}Z(`call`).addEventListener(`click`,Rb),Z(`call-end`).addEventListener(`click`,zb),Z(`call-type`).addEventListener(`click`,()=>{zb(),Mb.focus()}),Z(`call-mute`).addEventListener(`click`,()=>{$.unlock(),Fb=!Fb,Z(`call-mute`).classList.toggle(`muted`,Fb),Fb?(sb.cancel(),lb===`listening`&&vb(`offline`),bb(`Muted.`)):((ub||$.speaking)&&kb(),bb(``),Ab())}),Z(`hands`).addEventListener(`click`,async()=>{if(fb){fb.stop(),fb=null,Z(`hands`).classList.remove(`on`),Z(`cam`).classList.add(`hidden`);return}yb(`sys`,`Loading hand tracking… the eye follows your hand. Pinch + drag to tilt, pinch with both hands to zoom.`);try{let{startHandTracking:e}=await Le(async()=>{let{startHandTracking:e}=await import(`./handTracking-DeSThgqc.js`);return{startHandTracking:e}},[],import.meta.url);fb=await e(`https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@1.0.1/wasm`),Z(`hands`).classList.add(`on`),Z(`cam`).classList.remove(`hidden`)}catch(e){yb(`sys`,`Hand tracking failed: ${e.message}`)}});var Bb=[[0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[5,9],[9,10],[10,11],[11,12],[9,13],[13,14],[14,15],[15,16],[13,17],[0,17],[17,18],[18,19],[19,20]];function Vb(e,t){let n=Z(`cam`),r=n.getContext(`2d`);if(r&&fb){r.save(),r.translate(n.width,0),r.scale(-1,1),r.globalAlpha=.35,r.drawImage(fb.video,0,0,n.width,n.height),r.globalAlpha=1,r.strokeStyle=t?`#c9fbff`:`#2fd8ff`,r.lineWidth=1.5,r.beginPath();for(let t of e)for(let[e,i]of Bb)r.moveTo(t[e].x*n.width,t[e].y*n.height),r.lineTo(t[i].x*n.width,t[i].y*n.height);r.stroke(),r.restore()}}var Hb=Z(`settings`);function Ub(){let e=Z(`s-voice`),t=Q.speechLang.split(`-`)[0],n=ab.voices().filter(e=>e.lang.startsWith(t)).sort((e,t)=>e.name.localeCompare(t.name));e.replaceChildren(new Option(`Default`,``),...n.map(e=>new Option(`${e.name} (${e.lang})`,e.voiceURI))),e.value=Q.voiceURI}typeof speechSynthesis<`u`&&speechSynthesis.addEventListener?.(`voiceschanged`,Ub);var Wb=``;async function Gb(e){let t=Z(`s-eleven-voice`),n=Z(`s-eleven-status`);if(!e){t.replaceChildren(new Option(`Add a key first`,``)),n.textContent=``,Wb=``;return}if(e!==Wb){n.textContent=`Loading your voices…`;try{let r=await ac(e);Wb=e,t.replaceChildren(...r.map(e=>new Option(`${e.name}${e.labels?.accent?` · ${e.labels.accent}`:``}`,e.voice_id))),r.some(e=>e.voice_id===Q.elevenVoiceId)||(Q.elevenVoiceId=lc(r)),t.value=Q.elevenVoiceId,n.textContent=r.length?`${r.length} voices. Pick the most human-sounding one.`:`No voices on this account.`}catch(r){if(sc(r)){Wb=e,t.replaceChildren(new Option(`${oc.name} (default)`,oc.voice_id)),Q.elevenVoiceId=oc.voice_id,n.textContent=`This key can't list voices, so Ultron uses Adam. Give the key the voices_read permission to pick others.`;return}t.replaceChildren(new Option(`Couldn't load voices`,``)),n.textContent=r instanceof rc?r.message:`Couldn't reach ElevenLabs: ${r.message}`}}}function Kb(){Z(`s-key`).value=Q.apiKey,Z(`s-gemini`).value=Q.geminiKey,Z(`s-groq`).value=Q.groqKey,Z(`s-model`).value=Q.model,Z(`s-eleven-key`).value=Q.elevenKey,Z(`s-eleven-id`).value=Q.elevenCustomVoiceId,Z(`s-lang`).value=Q.speechLang,Z(`s-style`).value=Q.voiceStyle,Z(`s-engine`).value=Q.voiceFast?`fast`:`human`,Z(`s-speed`).value=String(Q.voiceSpeed),Z(`s-depth`).value=String(Q.voiceDepth),qb(),Z(`s-damage`).value=String(Q.damage),Z(`s-damage-val`).textContent=`${Math.round(Q.damage*100)}%`,Z(`s-search`).checked=Q.webSearch,Ub(),Gb(Q.elevenKey),Z(`s-build`).textContent=`Build 2026-09-26 11:17 · Groq ${ob(Q.groqKey)} · Gemini ${ob(Q.geminiKey)} · Anthropic ${ob(Q.apiKey)} · ElevenLabs ${ob(Q.elevenKey)}`,Z(`s-memory`).replaceChildren(...(Oc().length?Oc():[`(nothing yet)`]).map(e=>Object.assign(document.createElement(`li`),{textContent:e})))}Z(`s-model`).append(...Object.entries(pc).map(([e,t])=>new Option(t.label,e))),Z(`open-settings`).addEventListener(`click`,()=>{Kb(),Hb.showModal()}),Z(`s-eleven-key`).addEventListener(`change`,()=>Gb(Z(`s-eleven-key`).value.trim()));function qb(){Z(`s-speed-val`).textContent=`${Q.voiceSpeed.toFixed(2)}×`,Z(`s-depth-val`).textContent=`${Math.round(Q.voiceDepth*100)}%`}Z(`s-speed`).addEventListener(`input`,e=>{Q.voiceSpeed=Number(e.target.value),$.speed=Q.voiceSpeed,qb()}),Z(`s-depth`).addEventListener(`input`,e=>{Q.voiceDepth=Number(e.target.value),$.depth=Q.voiceDepth,qb()}),Z(`s-damage`).addEventListener(`input`,e=>{Sb(Number(e.target.value)),Z(`s-damage-val`).textContent=`${Math.round(Q.damage*100)}%`}),Z(`s-lang`).addEventListener(`change`,()=>{Q.speechLang=bc(Z(`s-lang`).value),Ub()}),Z(`s-clear-chat`).addEventListener(`click`,()=>{Eb.reset(),Z(`log`).replaceChildren(),yb(`sys`,`Chat cleared.`)}),Z(`s-clear-memory`).addEventListener(`click`,()=>{confirm(`Wipe everything Ultron remembers about you?`)&&(kc([]),Kb())}),Hb.addEventListener(`close`,()=>{let e=!!Q.groqKey,t=!!Q.geminiKey;Q.apiKey=Z(`s-key`).value.trim(),Q.geminiKey=Z(`s-gemini`).value.trim(),Q.groqKey=Z(`s-groq`).value.trim(),Q.model=Z(`s-model`).value,!e&&Q.groqKey?Q.model=gc.groq:!t&&Q.geminiKey&&(Q.model=gc.gemini),Q.elevenKey=Z(`s-eleven-key`).value.trim(),Q.elevenVoiceId=Q.elevenKey?Z(`s-eleven-voice`).value||Q.elevenVoiceId:``,Q.elevenCustomVoiceId=Z(`s-eleven-id`).value.trim().replace(/[^A-Za-z0-9]/g,``),Q.voiceURI=Z(`s-voice`).value,Q.voiceStyle=Z(`s-style`).value,Q.voiceFast=Z(`s-engine`).value===`fast`,$.fast=Q.voiceFast,$.setStyle(Q.voiceStyle),Q.speechLang=bc(Z(`s-lang`).value),Q.webSearch=Z(`s-search`).checked,$.voiceURI=Q.voiceURI,$.lang=Q.speechLang,cb(),Q=Ec(Q),Dc(Q),Cb(0)});var Jb=Z(`welcome`);Jb.addEventListener(`close`,async()=>{let e=Z(`w-key`).value.trim(),t=Z(`w-eleven`).value.trim();if(e){let t=_c(e);t?(t===`groq`?Q.groqKey=e:t===`gemini`?Q.geminiKey=e:Q.apiKey=e,Q.model=gc[t]):yb(`sys`,`That key doesn't look like a Groq (gsk_…), Gemini (AIza…) or Anthropic (sk-ant-…) key.`)}if(t&&(Q.elevenKey=t),Dc(Q),t){try{Q.elevenVoiceId=lc(await ac(t))}catch(e){sc(e)?Q.elevenVoiceId=oc.voice_id:yb(`sys`,e instanceof rc?e.message:`Couldn't reach ElevenLabs; check the key in settings.`)}cb()}Dc(Q),e&&yb(`sys`,`Keys saved. Type below, tap 🎙 for a voice message, or 📞 to call me.`)}),addEventListener(`error`,e=>yb(`sys`,`⚠ ${e.message||`Script error`}`)),addEventListener(`unhandledrejection`,e=>yb(`sys`,`⚠ ${e.reason?.message||String(e.reason)}`)),vb(`offline`),Cb(0),yb(`sys`,Db()?`Online. Type, send a voice message, or call me.`:`Add your free Groq key to wake me.`);var Yb=`ultron.freekey.prompted`,Xb=!1;try{Xb=!!localStorage.getItem(Yb),!Q.groqKey&&!Q.geminiKey&&!Xb&&localStorage.setItem(Yb,`1`)}catch{}(!Db()||!Q.groqKey&&!Q.geminiKey&&!Xb)&&Jb.showModal(),`serviceWorker`in navigator&&navigator.serviceWorker.register(`./sw.js`).catch(()=>{});export{o as i,Ai as n,Le as r,ki as t};